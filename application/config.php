<?php        
    ...
    define('URL', 'http://192.168.5.244/');            //здесь прописывется полный URL сайта
    ...
    define("FTP_SITE_USER", 'root'); //Изменить потом на upload
    ...
    //база данных UTF-8
    define('DB_USERNAME', 'insurance2');
    define('DB_PASS', 'insurance2');
