<?php
    ...
    if(isset($_POST['BRANCHID'])){
        ...
        $sql_add_position = "insert into DIC_DOLZH (ID, D_NAME, D_NAME_KAZ, BRANCH_ID, CNT, ID_DEPARTMENT, ID_PODPIS, OSNOVANIE) VALUES (SEQ_DIC_DOLZH.nextval, '$D_NAME', '$D_NAME_KAZ', '$BRANCH_ID', '$CNT', '$JOB_SP', '$sign', '$osn')";
    ...
    if(isset($_POST['fact'])){
        ...
        $sql_upd_triv = "update SUP_PERSON set $elem_name = '$this_val' where ID = $pers_id";
