<?php
    ...
    $html = '<div align="center">
            <div align="justify" style="float: left; width: 48%; margin-right: 10px; font-size: 10px; float: left; font-family: TimesNewRoman;
                ...
                <strong>«Мемлекеттік аннуитеттік компания» 
                өмірді сақтандыру  компаниясы” АҚ-да 
                ...
                «Мемлекеттік аннуитеттік компания»  өмірді сақтандыру бойынша компаниясы» АҚ (бұдан әрі –Қоғам) Жұмыскері бола отырып, Қоғаммен еңбек (қызмет) қарым-қатынастары  кезеңінде, менімен жасалған Еңбек шартының шарттарына сәйкес және ол аяқталғаннан кейін 3 (үш) жыл мерзім ішінде:
                </p>
                <p align="justify" style="text-indent: 10px;">
                Жариялануы (беруі, жайылуы) қаржылық жоғалтуларға, материалдық зиянға, сондай-ақ Қоғам имиджіне зор шығын келтіруге әкелетін, Қоғамның құпия ақпаратына жатқызылған, Қоғамдағы еңбек қызметі барысында маған сеніп тапсырылған немесе белгілі болған  мәліметтерді жарияламауға.
                </p>
                <p align="justify" style="text-indent: 10px;">
                ...
                <p align="justify" style="text-indent: 10px;">
                осы келісімді сақтамауға байланысты менің әрекеттерімнің салдарынан Қоғамға келтірілген шығындарды өтеуге менің міндетті болатындығым туралы хабарландым.  
                </p><br />
    ...
    <div align="justify" style="float: left; width: 48%; margin-right: 10px; font-size: 10px; float: left; font-family: TimesNewRoman;
                ...
                <strong>о  неразглашении  конфиденциальной информации 
                 в АО «Компания по страхованию жизни 
                «Государственная аннуитетная компания»</strong>
                </div>
                <p align="justify" style="text-indent: 10px;">
                Я, '.$name.' '.$lastname.' '.$middlename.',
                являясь работником АО «Компания по страхованию жизни «Государственная аннуитетная компания» (Далее - «Общество»), в период действия трудовых (служебных) отношений с Обществом, в соответствии с условиями заключенного со мной  Трудового договора и в течение 3 (трех) лет после его окончания, обязуюсь:
                </p>
                <p align="justify" style="text-indent: 10px;">
                ...
                <p align="justify" style="text-indent: 10px;">
                я буду обязан (а) возместить убытки, понесенные Обществом, вследствие моих действий по несоблюдению данного соглашения.
                </p><br />
