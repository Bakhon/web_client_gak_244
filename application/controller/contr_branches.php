<?php
    ...
    $sql = "select * from DIC_BRANCH order by RFBN_ID";
    ...
    if(isset($_POST['DIC_DEPARTMENT_NEW']))
    {
        ...
        $sql = "insert into DIC_DEPARTMENT (ID, NAME_KAZ, NAME, BRANCH_ID) values (SEQ_DIC_DEPARTMENT.nextval, '$NAME_KAZ', '$NAME', '$BRANCH_ID')";
