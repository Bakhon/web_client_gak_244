...
$list_sign = $db->select("select * from dic_dolzh where id = $pos_id");
//print_r($list_sign);
$id_podpisant = $list_sign[0]['ID_PODPIS'];
$list_podps = $db->select("select * from sup_person where id=$id_podpisant");
//print_r($list_podps);
$lastname_sign = $list_podps[0]['LASTNAME'];
$firsname_sign = $list_podps[0]['FIRSTNAME'];
$id_d = $list_podps[0]['JOB_POSITION'];
$list_dlz = $db->select("select * from dic_dolzh where id =$id_d ");
$dolzhnst_kaz = $list_dlz[0]['D_NAME_KAZ'];
$dolzhnost_ru = $list_dlz[0]['D_NAME'];
$firstname_short = mb_substr($firsname_sign, 0,1, "UTF-8");
...
'.$firstname_short.'.'.$lastname_sign.'</strong>
                        </font>
...
<div style="font-size: 14pt;">
                        <font face="verdana">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Бұйрықпен таныстырылды:
                                ...
                                <br><br>
                        <font face="verdana">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$name_first_simb.'. '.$middlename_first_simb.'. '.$lastname.' _____________ 2018 жылғы «___» _________
                        </font>
                        </div>
...
<div border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: "Times New Roman", Times, serif; 
            ...
            <br><br><br><br><br><br>
                    <div style="font-size: 14pt; ">                    
                       <font face="verdana">
                               <strong><br><br><br><br>О повышении должностного оклада '.$lastname.' '.$name_first_simb.'. '.$middlename_first_simb.'.</strong><br><br> 
                        </font>
                    </div>
                    <div style="text-indent: 30px; font-size: 14pt; text-align: justify;">
                        <font face="verdana">
...
'.$firstname_short.'.'.$lastname_sign.'</strong>
                        ...
                        <font face="verdana">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Приказом ознакомлен:
                                ...
                                <br><br>
                        <font face="verdana">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$name_first_simb.'. '.$middlename_first_simb.'. '.$lastname.' _____________ 2018 год «___» _________
                        </font>
                        </div><br><br>
                    </div>
                <p></p>
