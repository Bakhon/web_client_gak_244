                    ...
                    where KIND.ID = DOC.KIND and 
                        ...
                        ( select DISTINCT (MAIL_ID) 
                            ...
                            where 
                                ...
                                (SENDER_MAIL =  '$emp_mail' or RECIEP_MAIL =  '$emp_mail')) 
                        and (rec.STATE = 3 or rec.STATE = 8 or rec.STATE = 7 or rec.STATE = 9) 
                        order by rec.POST_DATE DESC";
