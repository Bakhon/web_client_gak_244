<?php
    ...
    $title = 'Печатная форма типовых форм';
    ...
    ($js_loader,        
        ...
        'styles/js/demo/typical_contract_editor.js'
    );        
	...
	require_once 'methods/contract_editor.php';
    $typical_forms = new TYPICAL_FORMS();
    $dan = $typical_forms->dan;
