<?php
  ...
  //  print_r($list_podpisant);
    ...
    $day = date("d", $time);
    $mon = date("m", $time);  
    $branch_num = $empInfo[0]['BRANCHID_NUM'];
    //transfer
    
   if($branch_num == '0000')
   {
    $text_shapka = '«18» марта 2020 года';
    $text_shapka_kaz = '2020 жылғы «18» наурыз';
    $perehod  = '19 марта 2020 года';
    $perehod_kaz = '2020 жылғы 19 наурыздан';
   }else{
    $text_shapka = '«31» марта 2020 года';
    $text_shapka_kaz = '2020 жылғы «31» наурыз';
    $perehod = '1 апреля 2020 года';
    $perehod_kaz = '2020 жылғы 1 сәуірден';
   }
    ...
    $html =   '<div align="justify" style="float: left; width: 100%; margin-right: 10px;  float: left; font-family: TimesNewRoman;
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <strong>'.$text_shapka.'</strong><br><br>
               <div align="justify" style="text-indent: 10px;">
                ...
                <div align="justify" style="text-indent: 10px;">
                1.	Работодатель переводит Работника на дистанционную работу с '.$perehod.', с местом выполнения работы по адресу: г. '.$cityname.', ул. '.$fact_street.', дом '                      .$fact_address_building.', кв. '.$fact_address_flat.'
                </div>
                <div align="justify" style="text-indent: 10px;">
                2. Работодатель имеет право осуществлять контроль рабочего времени Работника, с использованием технических средств связи и переписки по электронной почте.
                </div>
                <div align="justify" style="text-indent: 10px;">
                 3.	Работник использует собственные   средства коммуникаций.
                </div>
                <div align="justify" style="text-indent: 10px;">
                4. Работник обязуется исполнять запросы Работодателя, направленные на электронный адрес Работника '.$job_email.' и мобильный тел. '.$telNum.' . 
                </div>                
                <div align="justify" style="text-indent: 10px;">
                5. Работник обязуется соблюдать Правила трудового распорядка Работодателя и режим рабочего времени, предусмотренный Договором в месте выполнения работы, предусмотренной настоящим Соглашением. 
                </div>
                <div align="justify" style="text-indent: 10px;">
                6. Работник обязуется являться в место нахождения Работодателя по письменному требованию, направленному непосредственным руководителем и/или кадровым администратором на электронный адрес, указанный в пункте 4 настоящего Соглашения.     
                </div>
                <div align="justify" style="text-indent: 10px;">
                7. Условия    Договора,     не     затронутые    настоящим Соглашением, остаются в неизменном виде, и стороны подтверждают по ним свои обязательства.     
                </div>
                <div align="justify" style="text-indent: 10px;">
                8. Соглашение вступает в силу с '.$perehod.' и действует до письменного указания Работодателя, направленного в порядке, предусмотренном пунктом 6 настоящего Соглашения.     
                </div>
                <div align="justify" style="text-indent: 10px;">
                9. Все остальные условия Договора, не затронутые настоящим Дополнительным соглашением, остаются в неизменном виде и Стороны подтверждают по ним свои обязательства.     
                </div>
                <div align="justify" style="text-indent: 10px;">
                10. Настоящее Дополнительное соглашение вступает в силу с момента подписания Сторонами и является неотъемлемой частью Договора.     
                </div>
                <div align="justify" style="text-indent: 10px;">
                11.  Настоящее Дополнительное соглашение составлено в двух экземплярах, на русском и казахском языках, имеющих одинаковую юридическую силу, по одному экземпляру для каждой из Сторон.          
                </div>                              
                <br/>
               <div align="justify" style="text-indent: 10px;">
                ...
                <br/>
                <div align="justify" style="text-indent: 10px;">
                Юридический и фактический адрес: г. Нур-Султан, ул. Мәңгілік Ел 20, БЦ "Palazzo degli affari", 2-3 этаж.
                </div>               
                <div align="justify" style="text-indent: 10px;">
            ...
            <div align="justify" style="float: left; width: 100%; margin-right: 10px; float: left; font-family: TimesNewRoman;
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <strong>'.$text_shapka_kaz.'</strong><br><br>
               <div align="justify" style="text-indent: 10px;">
                ...
                <div align="justify" style="text-indent: 10px;">
                1. Жұмыс беруші Қызметкерді '.$perehod_kaz.' бастап Нұр-Сұлтан қ., '.$fact_street.' көшесі, '.$fact_address_building.' үй, '.$fact_address_flat.' п., мекен-жайы бойынша жұмысты орындайтын орнына қашықтықтан жұмысқа ауыстырады
                </div>
                <div align="justify" style="text-indent: 10px;">
                2. Жұмыс беруші Қызметкердің жұмыс уақытын техникалық байланыс құралдарын және хат алмасуды электронды пошта арқылы бақылауға құқылы.
                <br/>
                3. Қызметкер дербес ақпараттық және коммуникациялық технологияларды пайдаланады.
                </div>
                <div align="justify" style="text-indent: 10px;">
           		4. Қызметкер '.$job_email.' электрондық поштасына және '.$telNum.' ұялы нөміріне жіберілген Жұмыс берушінің өтініштерін орындауға міндеттенеді.
                </div>                 
                <div align="justify" style="text-indent: 10px;">
           		5. Қызметкер осы Келісімде көзделген жұмысты орындау орнында Жұмыс берушінің Еңбек тәртіптемесі ережелерін сақтауға және Шартта көзделген жұмыс уақытының режимін сақтауға міндеттенеді.
                </div>                               
                <div align="justify" style="text-indent: 10px;">
           		6. Қызметкер осы Келісімнің 4- тармағында көрсетілген электрондық мекенжайға тікелей басшы және/немесе кадр әкімшісі жіберген жазбаша талап бойынша жұмыс берушінің орналасқан жеріне келуге міндеттенеді. 
                </div>
                 <div align="justify" style="text-indent: 10px;">
				7. Осы Келісімде Шарттың қарастырылмаған талаптары өзгеріссіз қалады және тараптар олар бойынша өздерінің міндеттемелерін растайды.  
                </div>
                 <div align="justify" style="text-indent: 10px;">
				8. Келісім '.$perehod_kaz.' бастап күшіне енеді және осы Келісімнің 6- тармағында көзделген тәртіппен жіберілген Жұмыс берушінің жазбаша нұсқауына дейін қолданылады. 
                </div>
                 <div align="justify" style="text-indent: 10px;">
           		9. Осы Қосымша келісімде қарастырылмаған Шарттың басқа ережелері өзгеріссіз түрінде қалады және Тараптар олар бойынша өздерінің міндеттемелерін растайды. 
                </div>
                 <div align="justify" style="text-indent: 10px;">
  		        10. Осы Қосымша келісім Тараптармен қол қойылған күннен бастап күшіне енеді және  Шарттың ажырамас бөлігі болып табылады. 
                </div>
                 <div align="justify" style="text-indent: 10px;">
  		        11. Осы Қосымша келісім Тараптардың әрқайсысы үшін бір-бір данадан бірдей заңды күші бар  қазақ және орыс тілінде екі түпнұсқалық данада жасалған. 
                </div>
                <br/>                                  
               <div align="justify" style="text-indent: 10px;">
