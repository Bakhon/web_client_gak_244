...
$empInfo = $db->select("select triv.*, d.*, sp.lastname lastname_podpis, substr(sp.firstname, 1 ,1) firstname_podpis, sp.middlename middlename_podpis, dd.d_name dname, DD.D_NAME_KAZ dnamekaz from sup_person triv, dic_dolzh d, sup_person sp, dic_dolzh dd where triv.id = $empId and triv.job_position = d.id and d.id_podpis = sp.id and sp.job_position = dd.id");
...
$dolzhnost_kaz = $empInfo[0]['DNAMEKAZ'];
$dolzhnost_rus = $empInfo[0]['DNAME'];
$name_podpisant = $empInfo[0]['FIRSTNAME_PODPIS'];
$lname_podpisant = $empInfo[0]['LASTNAME_PODPIS'];
$d = getdate();
            ...
            line-height: 1.0;">
                <p>
                    ...
                    <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                     ...
                     <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                        <font face="verdana">
                            2. Бухгалтерлік есеп және қаржылық есептілік департаменті тәуліктік шығындарды, қонақ үй шығындары, '; 
                ...
                $html .= 'төленсін.
                    ...
                    <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                        <font face="verdana">
                            3. Бұл бұйрық қол қойылған күннен бастап күшіне енеді.
                        </font>
                    </div>';
                    if($empId == 315) {
                        
                   $html .= '<div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                        <font face="verdana">
                            4. '.$DATE_BEGIN.' бастан '.$DATE_END.' дейін Басқарма төрағасының міндеттерін атқаруды Басқарма төрағасының орынбасары Маканова Асель Куандыковнаға  жүктеймін.
                        </font>
                    </div>';
                    }
                   $html .= '<div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                    ...
                    <div style="text-indent: 30px; font-size: 14pt;">
                        <font face="verdana">
                            <strong>'.$dolzhnost_kaz.' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
'.$name_podpisant.'.'.$lname_podpisant.'</strong>
                        </font>
...
<div border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: "Times New Roman", Times, serif; 
            ...
            <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                    ...
                    <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                        <font face="verdana">
                            1. Командировать '.$posName.' '.$depName.' '.$lastname.' '.$name.' '.$middlename.' в город '.$FINAL_DESTINATION.' на '.$CNT_DAYS.' дн., с '.$DATE_BEGIN.' г. по '.$DATE_END.' г. 
                        <font face="verdana">
                    </font></font></div><font face="verdana"><font face="verdana"> 
                    <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                        <font face="verdana">
                              2. Департаменту бухгалтерского учета и финансовой отчетности оплатить суточные расходы, расходы на проживание, проезд по маршруту ';
                            foreach($list_trip_detail as $k => $v){
...
$html .= '</font>
                   ...
                   $html .='<div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                        <font face="verdana">
                            Основание: служебная записка-обоснование
                        </font>
                    </div>
                    <br><br>
                    <div style="text-indent: 30px; font-size: 14pt;">
                        <font face="verdana">
                            <strong>'.$dolzhnost_rus.' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
'.$name_podpisant.'.'.$lname_podpisant.'</strong>
                        </font>
                    ...
                    <font face="verdana">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Приказом ознакомлен:
                            ...
                            <br><br>
                    <font face="verdana">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$name_first_simb.'. '.$middlename_first_simb.'. '.$lastname.' _____________ 2019 год «___» _________
                    </font>
                <p></p>
</font></font></div>
        ';
