<?php
 ...
 array_push
  ...
  $sql = "select l.*, e.EMP_ID emp_id from LIST_CAUSES l, EXECUTOR_CLAUSES e where l.ID = E.ID_ZAYAVKA and e.EMP_ID = $emp_id and (l.state = 2 or l.state = 6 or  l.SUCCESS = 1) order by 1";
