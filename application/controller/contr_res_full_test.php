<?php
    ...
    $id_user = $q[0]['ID']; 
     ...
     $sql_correct_answer = "select res.id, res.answer from users_result u, question_p q, result_p res, project p where u.id_project = p.id and p.id = $project_id and res.id_question = q.id and q.id_project = p.id and res.correct_answer = 1 group by RES.ANSWER, res.id";
     $list_correct_ans = $db -> select($sql_correct_answer);
//     print_r($list_correct_ans);
