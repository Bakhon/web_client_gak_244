<?php
    ...
    {        
        ...
        $sql_to_slide = "INSERT INTO SITE_MAIN_SLIDER (ID, SLIDE_HEAD_KAZ, SLIDE_TEXT_KAZ, SLIDE_HEAD_RU, SLIDE_TEXT_RU, SLIDE_HEAD_ENG, SLIDE_TEXT_ENG, BTN_TEXT_KAZ, BTN_TEXT_RU, BTN_TEXT_ENG, BTN_URL_RU, BTN_URL_KAZ, IMG_BASE64, EMP_ID, POST_DATE, POST_TIME)
                         VALUES (SEQ_SITE_MAIN_SLIDER.nextval, '$SLIDE_HEAD_KAZ', '$SLIDE_TEXT_KAZ', '$SLIDE_HEAD_RU', '$SLIDE_TEXT_RU', '$SLIDE_HEAD_ENG', '$SLIDE_TEXT_ENG', '$BTN_TEXT_KAZ', '$BTN_TEXT_RU', '$BTN_TEXT_ENG', '$BTN_URL_RU','$BTN_URL_KAZ', EMPTY_CLOB(), '$emp_id', '$today_date', '$now_time')
    ...
    $sql_slider = "select * from SITE_MAIN_SLIDER order by id";
