<?php
  ...
  //  print_r($list_podpisant);
    ...
    $html =   '<div align="justify" style="float: left; width: 100%; margin-right: 10px;  float: left; font-family: TimesNewRoman;
                ...
                <strong>"3" октября 2019 года</strong><br><br>
               <div align="justify" style="text-indent: 10px;">
                ...
                <div align="justify" style="text-indent: 10px;">
                1.	Стороны пришли к соглашению внести в Договор следующие изменения и дополнения:
                </div>
                <div align="justify" style="text-indent: 10px;">
                1)	в статье 2.2 Раздела 2 Договора:
дополнить подпунктами 2.2.3-1. и 2.2.3-2. следующего содержания:

                </div>
                <div align="justify" style="text-indent: 10px;">
                «2.2.3-1. в течение трех рабочих дней ознакомиться с должностной инструкцией, положением о Департаменте/Службе/Филиале, в котором предстоит работать Работнику; с правилами внутренней и информационной безопасности, требованиями противопожарной безопасности и иными актами Работодателя, непосредственно касающимися деятельности Работника;»;
                </div>
                <div align="justify" style="text-indent: 10px;">
                «2.2.3-2. использовать персональный компьютер только для выполнения своих должностных обязанностей;»;
                </div>
                <br/>
                <div align="justify" style="text-indent: 10px;">
                пункты 2.2.3. и 2.2.11. Договора изложить в следующей редакции: 
                </div>
                <div align="justify" style="text-indent: 10px;">
                «2.2.3. соблюдать внутренний трудовой распорядок, указанные в статьях 5.3, 5.4  настоящего Договора, профессиональную этику и трудовую дисциплину;».
                </div>
                <div align="justify" style="text-indent: 10px;">
                 «2.2.11. подписать Соглашение о неразглашении конфиденциальной информации Работодателя;».
                </div>
                <br/>                
                 <div align="justify" style="text-indent: 10px;">
                 2)	статью 3.1 Раздела 3 Договора дополнить пунктом 3.1.11-1. следующего содержания:
                </div>
                <div align="justify" style="text-indent: 10px;">
                  «3.1.11-1. в целях контроля действий Работника, эффективного использования им рабочего времени, предотвращения утечки конфиденциальной информации, устанавливать на персональный компьютер Работника программу, предназначенную для сбора и анализа сведений по мониторингу действий пользователя (Работника), в том числе просматривать поток информации, обмен сообщениями посредством электронной почты, систему обмена мгновенными сообщениями, печать и т.д.;».
                </div>
                <br/>
                <div align="justify" style="text-indent: 10px;">
                  статью 3.2 Раздела 3 дополнить пунктом Пункт 3.2.9. следующего содержания	:
                </div>
                <div align="justify" style="text-indent: 10px;">
                  «3.2.9. при приеме на работу ознакомить Работника с внутренним трудовым распорядком; должностной инструкцией; положением о Департаменте/Службе/Филиале, в котором предстоит работать Работнику; с правилами внутренней и информационной безопасности, требованиями противопожарной безопасности и иными актами Работодателя, непосредственно касающимися деятельности Работника и другими внутренними нормативными документами;».
                </div>
                <div align="justify" style="text-indent: 10px;">
                  3)	в статье 3.2 Раздела 3 Договора:
                </div>
                <div align="justify" style="text-indent: 10px;">
                  пункты 3.2.10. и 3.2.18. изложить в следующей редакции:
                </div>
                <div align="justify" style="text-indent: 10px;">
                  «3.2.10. обеспечивать соблюдение внутреннего трудового распорядка;»;
                </div>
                <div align="justify" style="text-indent: 10px;">
                  «3.2.18. осуществлять обязательное социальное страхование и обязательное медицинское страхование Работника;».
                </div>
                <br/>
                <div align="justify" style="text-indent: 10px;">
                  дополнить пунктом 3.2.10-1 следующего содержания:
                </div>                
                <div align="justify" style="text-indent: 10px;">
                  «3.2.10-1. уведомить работника об использовании программы по контролю действий работника на персональном компьютере;».
                </div>
                <div align="justify" style="text-indent: 10px;">
                  4) абзац второй статьи 4.1 Раздела 4 исключить.
                </div>
                <div align="justify" style="text-indent: 10px;">
               ...
               <div align="justify" style="text-indent: 10px;">
                ...
                <br/>
                <div align="justify" style="text-indent: 10px;">
                Юридический и фактический адрес: г. Нур-Султан, ул. Мангилик Ел 20
                </div>
                <div align="justify" style="text-indent: 10px;">
                 БЦ "Palazzo degli affari"
                </div>
                <div align="justify" style="text-indent: 10px;">
            ...
            <div align="justify" style="float: left; width: 100%; margin-right: 10px; float: left; font-family: TimesNewRoman;
                ...
                <strong>2019 жылғы "3" қазан</strong><br><br>
               <div align="justify" style="text-indent: 10px;">
               ...
               1.Тараптар Шартқа келесі өзгерістер мен толықтыруларды енгізу келісіміне келді:
                ...
                <div align="justify" style="text-indent: 10px;">
                1) Шарттың 2-бөлімінің 2.2-бабы: <br/>
келесі мазмұндағы 2.2.3-1 және 2.2.3-2 –тармақшалармен толықтырылсын: <br/>
«2.2.3-1. үш жұмыс күні ішінде лауазымдық нұсқаулықпен, Жұмыскер жұмыс жасайтын Департамент/Қызмет/Филиал туралы ережемен; ішкі және ақпараттық қауіпсіздік ережелерімен, өрт қауіпсіздігі талаптарымен және Жұмыскердің қызметіне тікелей қатысты Жұмыс берушінің өзге акттерімен танысуға;
                </div>
                <div align="justify" style="text-indent: 10px;">
                «2.2.3-2. жеке компьютерді тек өзінің лауазымдық міндеттерін орындауға пайдалануға;»
                </div>
                 <br/>
                <div align="justify" style="text-indent: 10px;">
                Шарттың 2.2.3 және және 2.2.11 -тармақтары келесі редакцияда жазылсын:<br/>
«2.2.3. осы Шарттың 5.3 және 5.4-тармақтарында көрсетілген ішкі еңбек тәртібі ережелерін, кәсіби этиканы және еңбек тәртібін сақтауға;».<br/>
«2.2.11. Жұмыс берушінің  құпия ақпаратын жарияламау туралы келісімге қол қоюға;».
                </div>
                <br/>
               
                <div align="justify" style="text-indent: 10px;">
                2) Шарттың 3-бөлімінің 3.1-бабы келесі мазмұндағы 3.1.11-1 –тармақпен толықтырылсын: 
                </div>
                <div align="justify" style="text-indent: 10px;">
                «3.1.11-1.<br/>
                «Жұмыскердің іс-қимылдарына, жұмыс уақытын тиімді пайдалануына, құпия ақпараттың жылыстауына бақылау жасау мақсатында Жұмыскердің жеке компьютеріне тұтынушының (Жұмыс берушінің) іс-қимыл мониторингі бойынша деректерді жинау және талдауға арналған бағдарламаны орнатуға, оның ішінде электрондық пошта, жедел хабарлама, баспа және т.б. алмасу жүйесі арқылы ақпарат ағымын, хабарламалар алмасуын қарауға және т.б.;
                </div>
                <br/>
                <div align="justify" style="text-indent: 10px;">
                 3-бөлімінің 3.2-бабы келесі мазмұндағы 3.2.9 –тармақпен толықтырылсын:
                </div>                                
                 <div align="justify" style="text-indent: 10px;">
                 «3.2.9. жұмысқа қабылдау кезінде Жұмыскерді ішкі еңбек тәртібі ережелерімен; лауазымдық нұсқаулықпен; Жұмыскер алдағы уақытта жұмыс істейтін Департамент /Қызмет/Филиал туралы ережемен; ішкі және ақпараттық қауіпсіздік ержелерімен, өртке қарсы қауіпсіздік талаптарымен және Жұмыскердің қызметіне тікелей қатысты Жұмыс берушінің өзге актілерімен және басқа ішкі нормативтік құжаттармен таныстыруға;
                </div>
                <div align="justify" style="text-indent: 10px;">
                  3) 3-бөлімнің 3.2-бабында </div>
                  
                 <div align="justify" style="text-indent: 10px;"> 3.2.10 және 3.2.18-тармақтары келесі редакцияда жазылсын:</div>
<div align="justify" style="text-indent: 10px;">«3.2.10. ішкі еңбек тәртібі Ережелерін сақтауды қамтамасыз етуге;»; </div>
<div align="justify" style="text-indent: 10px;">«3.2.18. Жұмыскердің міндетті әлеуметтік сақтандырылуын және міндетті медициналық сақтандыруын жүзеге асыруға;</div>

                <div align="justify" style="text-indent: 10px;">
                  келесі азмұндағы 3.2.10-1-тармақпен толықтырылсын:
                </div>
              
                <div align="justify" style="text-indent: 10px;">
                  «3.2.10-1. жеке компьютерде жұмыскердің іс-қимылдарын бақылау бойынша бағдарламаны қолдану туралы жұмыскерді хабардар етуге;
                </div>
                  <br/>
                <div align="justify" style="text-indent: 10px;">
                  4) 4-бөлімнің 4.1-бабының 2-абзацы алып тасталсын.
                </div>
                <br/>
