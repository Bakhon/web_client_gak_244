  ...
  //  print_r($list_podpisant);
    ...
    $html = '<div align="center">
            <div align="justify" style="float: left; width: 100%; margin-right: 10px; font-size: 14px; float: left; font-family: TimesNewRoman;            	
                ...
                № '.$JOB_CONTR_NUM.' жеке еңбек шартына <br/>                                        
                ...
                <p align="justify" style="text-indent: 10px;">
                <strong>ЖҰМЫС БЕРУШІ:</strong> “Мемлекеттік аннуитеттік компания” өмірді сақтандыру  компаниясы” акционерлік қоғамы, мемлекеттік  тіркеуі 15.06.2005 жылдан №19489-1901-АҚ, '.$na_osnovanie_kaz.' негізінде әрекет ететін '.$name_dolzhn_kaz.' тұлғасында '.$lastname_signer.' '.$firsname_s.' '.$middlename_s.', және
                </p>
                <p align="justify" style="text-indent: 10px;">
                ...
                Заңды және нақты мекенжайы: Нұр-Сұлтан қ. Мәңгілік Ел көшесі, 20-үй.<br />
                «Palazzo degli affari» БО <br />
                РНН 620300259355<br />
                Телефондары: 916-333.<br /><br />
               
                _____________________ <strong>Г. АМЕРХОДЖАЕВ</strong><br /><br />
    ...
    <div align="justify" style="float: left; width: 100%; margin-right: 10px; font-size: 14px; float: left; font-family: TimesNewRoman;            	
            	...
            	font-weight: 400;">
                <div style="text-align:  center;">
                <strong>ДОПОЛНИТЕЛЬНОЕ СОГЛАШЕНИЕ № ___<br/>
                ...
                <p align="justify" style="text-indent: 10px;">
                <strong>РАБОТОДАТЕЛЬ:</strong> Акционерное  общество  «Компания  по  страхованию  жизни «Государственная  аннуитетная  компания»,  государственная регистрация № 19489–1901-АО от 15.06.2005 года, в лице '.$name_dolzhn.' '.$lastname_signer.' '.$firsname_s.' '.$middlename_s.' '.$na_osnovanie.', и
                </p>
                <p align="justify" style="text-indent: 10px;">
                ...
                Юридический и фактический адрес:  г. Нур-Султан, ул. Мангилик Ел 20<br />
