<?php
    ...
    $sqlEmpInfo = "select triv.DATE_POST, 
                             ...
                             where TRIV.DOCPLACE = DOC_PLACE.ID and FAMILY.ID = TRIV.FAMILY and NATION.ID = TRIV.NACIONAL and triv.id = $empId";
   ...
   // print_r($list_trip_det);
    ...
    $sql_depart = "select NAME from DIC_DEPARTMENT where ID = $dep_id";
    // BRANCH_ID = $branch_id 
...
<div align="center" style="float: left; width: 100%; margin-right: 10px; font-size: 14px; float: left; font-family: TimesNewRoman; font-style: normal;">
    ...
    <div align="justify" style="border-bottom: black; font-size: 10px;">
                 ...
                 <p>
                <strong>Акционерное общество <br /> "Компания по страхованию жизни<br /> Государственная аннуитентная компания"</strong>  
                </p>
                <br />
                <br />
                <br />
    ...
    <div align="justify" style="float: left; width: 50%; ">
                ...
                <p align="justify">
                    <strong>  АО "Компания по страхованию жизни <br /> "Государственная аннуитетная компания" </strong> <br /> наименование организации
                </p>
                <p align="justify">
