<?php
	class ACTION
    {
        ...
        {                  
            ...
            $active_user_dan['mail'] = $_SESSION[USER_SESSION]['other']['mail'][0];              
        }
        
        
        public function ProvUserPage()
        {
            global $active_user_dan;
            global $page;
        ...
        public function UserdanBase($login)
        {                                  
            $db = new DB3();                       
            $list_users = array();            
            $sql = "select u.emp_id, u.branch_id, u.lastname, u.firstname, u.vcmail, u.avatar, u.login, d.name, d.short_name 
            from gs_emp u, dic_branch d where u.branch_id = d.rfbn_id and login = '$login'";            
            $list_users = $db->Select($sql);
            return $list_users;
        }
    
        public function UserRole($login)
        {
            $db = new DB3();            
            $role = array();                        
        ...
        public function LdapAllListGAK()
        {
            $ldap_domain = '@gak.local';
            $ldap_user = 'ldap';
            $ldap_pass = 'Astana2016';
        ...
        public function LdapOnePerson($login)
        {
            $ldap_domain = '@gak.local';
            $ldap_user = 'ldap';
            $ldap_pass = 'Astana2016';
        ...
        public function LdapListForDepartments()
        {
            $ldap_domain = '@gak.local';
            $ldap_user = 'ldap';
            $ldap_pass = 'Astana2016';
        ...
        public function LdapUserDan($login, $pass)
        {
        ...
        public function check_deleted_pers()
        {
            $db = new DB();
