                ...
                <div class="ibox-content">
                    <div class="row">  
                        ...
                        <div id="page0" style="display: <?php echo $block; ?>;">
                            ...
                            ?>
                            <div class="col-lg-12" id="set_group_dan" style="<?php echo $s; ?>">
                                <hr />                                
                                ...
                                <div class="col-lg-3">                        
                                    ...
                                    <input type="number" class="form-control" id="set_m_srok" value="<?php echo $dan['contract']['SROK_INS']; ?>" readonly/>
                                </div>
                                    ...
                                    <?php 
                                        if($edit){
                                            ...
                                            foreach($dan['clients'] as $k=>$v){
                                                ...
                                                foreach($v['NAGRUZ'] as $i=>$n){
                                                    $ds["risks"]['all'][] = array($n['ID_TYPE']=>$n['NAME']);
                                                }
                                                ...
                                                foreach($v['CALC'] as $i=>$c){
                                                    $ds["raschet"][] = array(
                                                        ...
                                                        "BRUTTO_TARIF"      => $c['BRUTTO_TARIF'],
                                                        "BRUTTO_TARIF_R"    => $c["BRUTTO_TARIF_R"],
                                                        "NETTO_TARIF"       => $c["NETTO_TARIF"],
                                                        "NETTO_TARIF_R"     => $c["NETTO_TARIF_R"],
                                                        "TARIF_REINS"       => $c["TARIF_REINS"],
                                                        "TARIF_REINS_R"     => $c["TARIF_REINS_R"],
                                                        "BRUTTO_P"          => $c["BRUTTO_P"],
                                                        "BRUTTO_P_R"        => $c["BRUTTO_P_R"],
                                                        "NETTO_P"           => $c["NETTO_P"],
                                                        "NETTO_P_R"         => $c["NETTO_P_R"],
                                                        "REINS_P"           => $c["REINS_P"],
                                                        "REINS_P_R"         => $c["REINS_P_R"],
                                                        "ERROR"             => '',
                                                        "SET_PREM"          => $set_prem
                                                    );
                                                }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="search_user_dan" style="display: none;">
                    ...
                    <input type="hidden" id="iedit" value="0" name="iedit"/>
