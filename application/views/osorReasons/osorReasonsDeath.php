...
<div class="row">
    <h4>Причина: Смерть</h4>
</div>
            <div id="death" class="tabs-container pole">
                                <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-1death">Смерть</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-2death">Транши</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-3death">Расчет выплаты</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="tab-1death" class="tab-pane active">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <label class="font-noraml">Возраст младшего ребенка</label>
                                                    <input type="number" class="form-control" placeholder="Только цифры" required>
                                                </div>
                                                ...
                                                <?php
                                                        echo FORMS::InputDate(2, 'Дата начала обучения', 'iCONTRACT_DATE', 'CONTRACT_DATE', 'form-control', '', false, false);
                                                        echo FORMS::InputDate(2, 'Дата начала обучения', 'iCONTRACT_DATE', 'CONTRACT_DATE', 'form-control', '', false, false);                                                        
                                                ?>                                                
                                            </div>
                                            <div class="row">
                                        ...
                                        <div id="tab-2death" class="tab-pane">
                                            <div class="panel-body">
                                        ...
                                        <div id="tab-3death" class="tab-pane">
                                            <div class="panel-body">
                                            <div class="row">
                                                    <div class="col-lg-2">
