<div class="row">
    <h4>Причина: Трудовое увечье</h4>
</div>
<div id="death" class="tabs-container pole">
                                <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-1mutilation">Смерть</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-2mutilation">Транши</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-3mutilation">Расчет выплаты</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="tab-1mutilation" class="tab-pane active">
                                        ...
                                        <div id="tab-2mutilation" class="tab-pane">
                                            <div class="panel-body">
                                        ...
                                        <div id="tab-3mutilation" class="tab-pane">
                                            <div class="panel-body">
                                            <div class="row">
                                                    <div class="col-lg-2">
