<div class="row">
    <h4>Причина: Перерасчет в связи с увеличением заработной платы на основании судебного акта</h4>
</div>
<div class="pole">
                                    <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-1recalculationCourt">Смерть</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-2recalculationCourt">Транши</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-3recalculationCourt">Расчет выплаты</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="tab-1recalculationCourt" class="tab-pane active">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php
                                                    echo FORMS::InputDate(2, 'Дата смерти', 'iCONTRACT_DATE', 'CONTRACT_DATE', 'form-control', '', false, false);
                                                ?>
                                                <div class="col-lg-2">
                                        ...
                                        <div id="tab-2recalculationCourt" class="tab-pane">
                                            <div class="panel-body">
                                        ...
                                        <div id="tab-3recalculationCourt" class="tab-pane">
                                            <div class="panel-body">
                                            <div class="row">
                                                    <div class="col-lg-2">
                                                    ...
                                                    <?php
                                                        echo FORMS::InputDate(2, 'Дата расчета', 'iCONTRACT_DATE', 'CONTRACT_DATE', 'form-control', '', false, false);
                                                    ?>
                                                    <div class="col-lg-2">
                                                    ...
                                                    <h4>Расходы СО(%)</h4>
                                                    <div class="col-lg-6">
                                                        <label class="font-noraml">От страховой преммии"</label>
                                                        <input type="number" class="form-control" placeholder="Только цифры" required>
                                                    </div>
                                                    <div class="col-lg-6">
