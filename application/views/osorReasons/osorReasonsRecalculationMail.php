<div class="row">
    <h4>Причина: Перерасчет в связи с увеличением заработной платы на основании письма</h4>
</div>
                                <div class="pole">
                                    <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-2recalculationMail">Транши</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-3recalculationMail">Несколько сроков в договоре</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="tab-2recalculationMail" class="tab-pane active">
                                        ...
                                        <div id="tab-3recalculationMail" class="tab-pane">
