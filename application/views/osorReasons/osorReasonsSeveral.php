<div class="row">
    <h4>Причина: Несколько сроков в одном договоре</h4>
</div>
<div class="pole">
                                    <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-2several">Транши</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-3several">Расчет выплаты</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="tab-2several" class="tab-pane active">
                                        ...
                                        <div id="tab-3several" class="tab-pane">
                                            <div class="panel-body">
                                            <div class="row">
                                                    <div class="col-lg-2">
