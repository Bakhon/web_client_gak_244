<div class="row">
    <div class="ibox">
        ...
        <div class="ibox-title">
            ...
            № 
            <?php echo $bordero->dan_array['ps']['CONTRACT_NUM'] ?> от
            <?php echo $bordero->dan_array['ps']['CONTRACT_DATE'] ?> г.
            </span> 
            </h3>
        </div>
        ...
        <tbody>
        <?php foreach($bordero->dan_array['list'] as $k=>$v){ 
            $transh = 'Нет';
            if(trim($v['ID_TRANSH']) !== ''){
                $transh = 'Да';
            }
        ...
        <div class="ibox-footer">
            <center>
                ...
                <a href="reins_bordero?list_contracts" class="btn btn-danger">Отмена</a>
            </center>
        </div>
        </form>
    </div>
