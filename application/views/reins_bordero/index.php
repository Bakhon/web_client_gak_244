...
<div class="row wrapper wrapper-content">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <a href="reins_bordero?list_transh" class="btn <?php echo $btn2; ?>"><i class="fa fa-list-ul"></i> Не сформированные c траншами</a>
                ...
                <div class="ibox-content" style="float: left;">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group col-lg-2" style="text-align: right;">
                            ...
                            if($dep == 13){
                            ?>
                            <span class="btn btn-default" id="del_list">Убрать из списка</span>
                            <?php } ?>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content bd_text" style="overflow: auto; width: 100%">
                <?php 
                    echo $bordero->html;
                ?>
                </div>
...
<script>
    ...
    $('#del_list').click(function(){
        ...
        $('.check').each(function(){            
            ...
            if(b == true){
                var ls = {
                    "cnct_id":$(this).attr('id'),
                    "id_transh": $(this).attr('transh')
                }
                //list_contracts.push($(this).attr('id'));                
                list_contracts.push(ls);                
            }            
        });
        if(list_contracts.length == 0){
            alert('Не выбран ни один договор!');
        }else{                        
            var js = JSON.stringify(list_contracts);
            $.post(window.location.href, {"del_list_bordero": js}, function(data){                
               if(data.trim() == ''){                
                  location.reload();
               }else{
                  alert(data);
