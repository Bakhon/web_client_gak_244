        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3>Перенос договоров № <?php echo $reins->dan_array['num']; ?></h3>
                </div>
                <div class="ibox-content">
                    <form method="post">
                    <input type="hidden" name="move_contract_id" value="<?php echo $reins->dan_array['id']; ?>"/>
                    ...
                    <tbody>
                    <?php
                        foreach($reins->dan_array['list'] as $k=>$v){
                    ?>
                    <tr>
                        <td><input type="checkbox" class="checkbox" name="move_cnct[]" value="<?php echo $v['CNCT_ID']; ?>"/></td>
                        <td><?php echo $v['NUM_DOG'] ?></td>
                        <td><?php echo $v['STRAH'] ?></td>
                        <td><?php echo $v['REINSNAME'] ?></td>
                        <td><center><?php echo $v['VIPLAT_BEGIN'] ?></center></td>
                        <td><center><?php echo $v['VIPLAT_END'] ?></center></td>
