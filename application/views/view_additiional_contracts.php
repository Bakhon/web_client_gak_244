                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-12">                            
                            ...
                            <select disabled="" name="iID_INSUR" id="id_insur" class="select2_demo_1 form-control chosen-select" required>
                    ...
                    <input hidden="" value="<?php echo $listLastContragents[0]['ID']; ?>" id="contrAgetnsId"/>
                        ...
                        <?php
                            ...
                            echo FORMS::InputText(3, 'Номер договора', 'iCONTRACT_NUM_ADDIT', 'iCONTRACT_NUM_ADDIT', '', 'form-control', $D.$addit_num, true);
                        ...
                        <?php 
                            ...
                            echo FORMS::InputDate(3, 'Дата договора (<strong>Шаг 2</strong>)', 'iCONTRACT_DATE', 'CONTRACT_DATE', 'form-control', '', false, array("data"=>$_GET['paym_code']),  'required');
                            
                            if(isset($dan['contracts'][0]['ZV_DATE'])){$D = $dan['contracts'][0]['ZV_DATE'];}ELSE{$D = '';}
                            if(isset($ds['iZV_DATE'])){$D = $dan['iZV_DATE'];}
                            echo FORMS::InputDate(3, 'Дата заявления (<strong>Шаг 2</strong>)', 'iZV_DATE', 'IZV_DATE', 'form-control', '', false, array("data"=>$_GET['paym_code']),  'required');
                        ?>
                        <div class="col-lg-5">
                    ...
                    <div class="row">
                        <div class="col-lg-5">                            
                            ...
                            <select disabled="" name="iSICID_AGENT" id="ISICID_AGENT" class="select2_demo_1 form-control chosen-select">
                            <option value="0">Не выбрано</option>
                            <?php                                
