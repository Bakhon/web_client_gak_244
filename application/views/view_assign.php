                        ...
                        <div class="ibox-content">
                            <table class="table table-striped table-bordered table-hover" id="editable">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2">Дата поручения</th>
                                    <th rowspan="2">Основание</th>
                                    <th rowspan="2">Ответственное СТП</th>
                                    <th colspan="2">Дата исполнения</th>
                                    <th rowspan="2">Последний комментарий</th>
                                    <th rowspan="2">Дата последнего комментария</th>
                                </tr>
                                <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr class="read">
                                       ...
                                       <td class="mail-subject"><a href="assign_detail?doc_id=<?php echo $v['ID']; ?>&get_file=<?php echo $v['ID'];?>"><?php echo $v['DATE_PROD']; ?></a></td>                                       
                                        <td class="mail-subject"><a href="assign_detail?doc_id=<?php echo $v['ID']; ?>&get_file=<?php echo $v['ID'];?>"><?php if(count($list_assign_comments) >= 1) { echo $list_assign_comments[0]['TEXT']; } ?></a></td>
                                        <td class="mail-subject"><a href="assign_detail?doc_id=<?php echo $v['ID']; ?>&get_file=<?php echo $v['ID'];?>"><?php if(count($list_assign_comments) >= 1) { echo $list_assign_comments[0]['DATE_OF_COMMENT']; } ?></a></td>
                                    </tr>
                                    <?php
                                        }
                                    ?>
                             ...
                             <form method="post" target="_blank" action="print_timesheet">
                                <textarea hidden="" name="content">
                                    <div style="text-align: center;">
                                        <strong>
                                            <h3>Действующие поручения на <?php echo $today_date.' (время: '.$now_time.')'; ?></h3>
                                        </strong>
                                    </div>
                                    <table>
                                        <thead>
                                        <tr style="border: 1px solid;">
                                            <th rowspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">№</th>
                                            <th rowspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">Заголовок</th>
                                            <th rowspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">Дата поручения</th>
                                            <th rowspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">Основание</th>
                                            <th rowspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">Ответственное СТП</th>
                                            <th colspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">Дата исполнения</th>
                                            <th rowspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">Последний комментарий</th>
                                            <th rowspan="2" style="border: 1px solid;background-color: #1c84c6; color: white;">Дата последнего комментария</th>
                                        </tr>
                                        
                                <tr>
                                 <th style="border: 1px solid;background-color: #1c84c6; color: white;">Дата исполнения</th>
                                 <th style="border: 1px solid;background-color: #1c84c6; color: white;">Дата продления</th>
                                </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px solid;"><?php echo $v['DATE_PROD']; ?></td>
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-sm btn-info"> Распечатать лист поручений </button>
                                </div>
                            </form>
                        </div>
                    </div>
