    ...
    <div class="row">
        ...
        <div class="col-lg-12 animated fadeInRight">
            <div class="mail-box-header">
                ...
                <h2>
                    Создать документ на исполнение
                </h2>
            </div>
            <div class="col-lg-12 animated fadeInRight">
                ...
                <div class="mail-box">
                    ...
                    <form enctype="multipart/form-data" class="form-horizontal" method="POST">
                        <div hidden="" class="form-group"><label class="col-sm-2 control-label">Current step</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="CURRENT_STEP" name="CURRENT_STEP" value="<?php echo $list_steps[1]['ID']; ?>"/>
                            </div>
                        </div>
                        <div hidden="" class="form-group"><label class="col-sm-2 control-label">Next step</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="NEXT_STEP" name="NEXT_STEP" value="<?php echo $list_steps[1]['ID_NEXT']; ?>"/>
                            </div>
                        </div>
                        <div hidden="" class="form-group"><label class="col-sm-2 control-label">Prev step</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="PREV_STEP" name="PREV_STEP" value="<?php echo $list_steps[1]['ID_PREV']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div hidden="" class="form-group"><label class="col-sm-2 control-label">Destination</label>
                            ...
                            <div class="col-sm-10">
                            <select class="select2_demo_1 form-control" name="DESTINATION" id="DESTINATION" required=""/>
                                <option></option>
                                <option value="4" selected="">На исполнение департаменту</option>
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Регистрационный номер:</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" value="<?php if($REG_NUM != ''){echo $REG_NUM;}else{echo '0';} ?>" id="REG_NUM" name="REG_NUM" required=""/>
                            </div>
                        </div>
                            ...
                            <div class="file-box">
                                <div class="file">
                                    <a href="ftp://upload:Astana2014@192.168.5.2/<?php echo $v; ?>">
                                        ...
                                        <div class="file-name">
                                            <a href="ftp://upload:Astana2014@192.168.5.2/<?php echo $v; ?>" target="_blank"><?php echo $v; ?></a>
                                            <br/>
