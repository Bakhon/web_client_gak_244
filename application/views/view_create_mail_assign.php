<div class="row">
    <div class="col-lg-12 animated fadeInRight">
        ...
        <?php $emp_mail = $_SESSION['insurance']['other']['mail'][0]; ?>        
            
            <?php if($emp_mail == 'a.auganbaeva@gak.kz') { ?>            
                <h2>Создать рекомендацию  </h2>
                <?php }  else {?>                
        ...
        <div class="col-lg-12 animated fadeInRight">
            ...
            <div class="mail-box">
                ...
                <form enctype="multipart/form-data" class="form-horizontal" method="POST" id="main_form">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Ответственное структурное подразделение:</label>
                        <div class="col-sm-10">
                            <select name="RECIPIENT_AGREEMENT[]" id="RECIPIENT_AGREEMENT" data-placeholder="Несколько получателей..." class="chosen-select col-lg-12" multiple tabindex="4">
                                <option></option>
                    ...
                    <script>
                        $('#RECIPIENT_AGREEMENT').change(
                            function()
                            {
                                var dep_name = $('#RECIPIENT_AGREEMENT option:selected').text()+' clicked!';
                                var realvalues = [];
                                var textvalues = [];
                                $('#RECIPIENT_AGREEMENT option:selected').each(function(i, selected)
                                {
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Дата поручения:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Дата исполнения:</label>
                        <div class="col-sm-10">
                            <div class="input-group date ">
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Основание</label>
                        <div class="col-sm-10">
                            <textarea id="COMMENT_TO_ASSIGN" class="form-control" name="COMMENT_TO_ASSIGN"></textarea>
                        </div>
                    </div>
                    <div hidden="" class="form-group"><label class="col-sm-2 control-label">статус:</label>
                        <div class="col-sm-10">
                            <input class="form-control" value="<?php echo '14'; ?>" id="STATE" name="STATE"/>
                        </div>
                    </div>
