    ...
    <div class="col-lg-12 animated fadeInRight">
            ...
            <div class="mail-box">
                ...
                <form enctype="multipart/form-data" class="form-horizontal" method="POST">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Наименование получателя</label>
                        <div class="col-sm-10">
                            <input class="form-control" id="ORG_SENDER" name="ORG_SENDER"/>
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label">Адрес получателя</label>
                        <div class="col-sm-10">
                    ...
                    <div hidden="" class="form-group"><label class="col-sm-2 control-label">статус:</label>
                        <div class="col-sm-10">
                            <input class="form-control" value="<?php if($trip_id == '2'){echo '1';}else{echo '9';} ?>" id="STATE" name="STATE"/>
                        </div>
                    </div>
                    <div class="form-group" <?php if($trip_id == '3'){$required_state = '';}else{$required_state = 'hidden="" style="display: none;"';} //echo $required_state; ?>><label class="col-sm-2 control-label">Согласующие:</label>
                        <div class="col-sm-10">
                            <select name="RECIPIENT_AGREEMENT[]" id="RECIPIENT_AGREEMENT" data-placeholder="Несколько получателей..." class="chosen-select col-lg-12" multiple tabindex="4" accesskey="" <?php if($trip_id == '2' OR $trip_id == '6'){$required_state = 'required=""';}else{$required_state = 'hidden="" style="display: none;" disabled=""';} echo $required_state; ?>>
                                <option></option>
                                <?php
                    ...
                    <div hidden="" class="form-group"><label class="col-sm-2 control-label">Канцелярия:</label>
                        <div class="col-sm-10"><input class="form-control" value="d.nurkeibekova@gak.kz" id="RECIEPMENTS_REGIST_OUT" name="RECIEPMENTS_REGIST_OUT" required="" readonly=""/></div>
                    </div>
                    <!--
                    <div class="form-group" <?php if($trip_id == '0'){$required_state = '';}else{$required_state = 'hidden="" style="display: none;"';} //echo $required_state; ?>><label class="col-sm-2 control-label">Резолюция:</label>
                        <div class="col-sm-10">
                            <select name="RECIPIENT_RESOLUTION[]" data-placeholder="Несколько получателей..." class="chosen-select col-lg-12" multiple tabindex="4" accesskey="" <?php if($trip_id == '3'){$required_state = 'required=""';}else{$required_state = 'hidden="" style="display: none;"';} echo $required_state; ?>>
                                <option></option>
                                <?php
                                    foreach($list_persons as $k => $v)
                                    {
                    ...
                    -->
                    <div class="form-group" <?php if($trip_id == '0'){$required_state = '';}else{$required_state = 'hidden="" style="display: none;"';} //echo $required_state; ?>><label class="col-sm-2 control-label">Подпись:</label>
                        <div class="col-sm-10">
                            <select name="DOC_RECIEPMENTS_SIGNATURE[]" id="DOC_RECIEPMENTS_SIGNATURE" data-placeholder="Несколько получателей..." class="chosen-select col-lg-12" tabindex="4" accesskey="" <?php if($trip_id == '3'){$required_state = 'required=""';}else{$required_state = 'hidden="" style="display: none;"';} echo $required_state; ?>>
                                <option></option>
                                <?php
                                    foreach($list_persons as $k => $v)
                                    {
                        ...
                        <div class="col-sm-10">
                            <select name="RECIPIENT[]" data-placeholder="Несколько получателей..." class="chosen-select col-lg-12" multiple tabindex="4"required="">
                                ...
                                <?php
                                    ...
                                    {
                                        if($v['EMAIL'] == '' || $v['ID'] == '14' || $v['ID'] == '0'){$v['EMAIL'] = '';}
                                ?>
                                    <option value="<?php echo $v['EMAIL']; ?>" <?php if($v['EMAIL'] == '' || $v['ID'] == '14' || $v['ID'] == '0'){echo 'disabled';} ?>></option>
                                <?php
                                    }
                                ?>
                            </select>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Привязан к письму:</label>
                        <div class="col-sm-10"><input class="form-control" id="LINK_FROM" name="LINK_FROM" value="" required="" placeholder="Если не привязан к письму, пропишите 0"/></div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Регистрационный номер:</label>
                        <div class="col-sm-10"><input disabled="" class="form-control" value="<?php // echo $REG_NUM_ID.'/'.$reg_num_next_val; ?>" id="REG_NUM" name="REG_NUM" /></div>
                    </div>
                ...
                <div class="mail-body">
                    <button type="submit" onclick=""   class="btn btn-sm btn-primary" title="Отправить"><i class="fa fa-reply"></i> Отправить</button>
