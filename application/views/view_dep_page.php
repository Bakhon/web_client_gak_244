                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <select name="CURATORS_ID" id="CURATORS_ID" class="select2_demo_1 form-control">
                                ...
                                <option value="426">А. Т. Бексеитова</option>
                            <?php
                                foreach($list_chiefs as $k=>$v){
                            ?>    
                                <option value="<?php echo $v['ID']; ?>" <?php if($list_cur[0]['CURATORS_ID'] == $v['ID']){echo 'selected';}?>><?php echo $v['FIO']; ?></option>
                            <?php
                                }
                            ?>
                                <option value="310">А. А. Акажанов</option>
                                <option value="1911">Ж. Б. Жумакова</option>
                            </select>                            
                        </div>
                        <div hidden="" class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <?php
                                ...
                                {
                            ?>
                                <option <?php if($list_dir[0]['DEPUTY'] == $v['ID']){echo 'selected';}?> value="<?php echo $v['ID']; ?>"><?php echo $v['FIO']; ?></option>
                            <?php
                                }
                            ?>
                            </select>                            
                        ...
                        <div hidden="" class="col-lg-3">
                            <label class="font-noraml">ID</label>
                            <input name="ID" id="ID" type="text" placeholder="" class="form-control" value="<?php echo $list_dir[0]['DEPUTY']; ?>"/>
                        </div>
                    </div>
                    <hr />
                    <div class="row">
