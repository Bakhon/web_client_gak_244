            ...
            <div class="ibox-content">
                <table class="table table-bordered">
                    ...
                    <?php 
                        if(count($dan) > 0){
                            foreach($dan as $k=>$v){
                                $s = "'".$v['ID']."', '".$v['METHOD_NAME']."', '".$v['METHOD_ACTION']."'";
                                echo '<tr>
                                    <td>'.$v['ID'].'</td>
                                    <td>'.$v['METHOD_NAME'].'</td>
...
<?php 
    ...
    <input type="hidden" name="id" value="0" class="id_method">'.             
             ...
             FORMS::FormHorizontalEdit(3, 9, 'Метод', 'METHOD_ACTION', '').'                    
             </form>';
    
    echo FORMS::ModalContainer("edit_method", 'Редактирвоание метода', '', $form, 'save();');
?>            
