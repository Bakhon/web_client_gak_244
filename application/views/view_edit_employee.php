               ...
               if(STATE == 0 || STATE == 8)
                   {
                       ...
                       alert('Заявка на вакансию не утверждена председателем');
                   }
                        else
                   {
...
<?php
   ...
   {
       if($_SESSION['insurance']['other']['mail'][0] != 'a.ibrayeva@gak.kz')
       {
           if($_SESSION['insurance']['other']['mail'][0] != 'a.makanova@gak.kz')
           {
               if($_SESSION['insurance']['other']['mail'][0] != 'i.gabdusheva@gak.kz')
               {
                   if($_SESSION['insurance']['other']['mail'][0] != 'n.kulzhanov@gak.kz')
                   {
                       if($_SESSION['insurance']['other']['mail'][0] != 'a.omarov@gak.kz')
                       {
                           if($_SESSION['insurance']['other']['mail'][0] != 'a.saleev@gak.kz')
                           {
                               if($_SESSION['insurance']['other']['mail'][0] != 'b.abdisamat@gak.kz')
                               {
                                  if($_SESSION['insurance']['other']['mail'][0] != 'a.adilkhankyzy@gak.kz')
                                    {
                                       if(trim($_SESSION['insurance']['other']['mail'][0]) != trim($empInfo[0]['EMAIL']))
                                         {
      ...
      <div class="col-lg-12">
         <div class="ibox float-e-margins">
            <div class="ibox-content">
               <div class="row">
                  <div class="col-lg-6">
                     <h4><?php echo $empInfo[0]['LASTNAME'].' '.$empInfo[0]['FIRSTNAME'].' '.$empInfo[0]['MIDDLENAME'].' ('.$list_dolzh[0]['D_NAME'].', '.$list_dep_name[0]['NAME'].')'; ?></h4>
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tabs-container">
                        <ul class="nav nav-tabs">
                           ...
                           <li class=""><a data-toggle="tab" href="#tab-10"> Обучение </a></li>
                           <li class=""><a data-toggle="tab" href="#tab-11"> Подписанты </a></li>
                        </ul>
                        <div class="tab-content">
                              ...
                              <div class="panel-body">
                                 <form method="POST" action="edit_employee">
                                    ...
                                    <div id="place_for_state_table">
                                       <div class="row">
                                          <div class="col-lg-6">
                                             ...
                                             <input disabled="" name="BRANCHID" placeholder="" class="form-control" id="BRANCHID" value="<?php echo $list_branch_name[0]['NAME']; ?>"/>
                                          </div>
                                          <div class="col-lg-6">
                                             <label class="font-noraml">Департамент</label>
                                             <input disabled="" name="JOB_SP" placeholder="" class="form-control" id="JOB_SP" value="<?php echo $list_dep_name[0]['NAME']; ?>"/>
                                          </div>
                                       </div>
                                       <br />
                                       <div class="row">
                                          <div class="col-lg-5">
                                             ...
                                             <input disabled="" name="JOB_POSITION" placeholder="" class="form-control" id="JOB_POSITION" value="<?php echo $list_dolzh[0]['D_NAME']; ?>"/>
                                          </div>
                                          <!--
                                             <div class="col-lg-5">
                                          ...
                                          <div class="col-lg-2">
                                             ...
                                             <input disabled="" name="OKLAD" placeholder="" class="form-control" id="OKLAD" value="<?php echo $empInfo[0]['OKLAD']; ?>"/>
                                          </div>
                                       </div>
                                    </div>
                                    <br/>
                                    ...
                                    <div class="row">
                                       <div class="col-lg-3">
                                          ...
                                          <input disabled="" name="" id="" type="text" class="form-control" value="<?php echo $empInfo[0]['NADBAVKA'];?>"/>
                                       </div>
                                    </div>
                                    <br />
                                    ...
                                    <div class="row">
                                       <div class="col-lg-3">
                                          ...
                                          <input disabled="" name="" id="" type="text" class="form-control" value="<?php echo $empInfo[0]['NADBAVKA_ECO'];?>"/>
                                       </div>
                                    </div>
                                    <br />
                                    ...
                                    <div class="row">
                                       <div class="col-lg-3">
                                          ...
                                          <input disabled="" name="" id="" type="text" class="form-control" value="<?php echo $empInfo[0]['PREMIUM'];?>"/>
                                       </div>
                                    </div>
                                    <br />
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-4">
                                          ...
                                          <input data-mask="+9-999-999-99-99" name="MOB_PHONE" type="tel" placeholder="" class="form-control" id="MOB_PHONE" value="<?php echo $empInfo[0]['MOB_PHONE'];?>"/>
                                       </div>
                                       <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-3">
                                          ...
                                          <div class="input-group date ">
                                             ...
                                             <input type="text" class="form-control dateOform" name="BIRTHDATE" data-mask="99.99.9999" id="BIRTHDATE" value="<?php echo $empInfo[0]['BIRTHDATE']?>" />
                                          </div>
                                       </div>
                                       <div class="col-lg-3">
                                 ...
                                 <div class="row">
                                    <div class="col-lg-2">
                                       ...
                                       <input  name="CONTRACT_JOB_NUM" type="text" placeholder="" class="form-control" id="CONTRACT_JOB_NUM" value="<?php echo $empInfo[0]['CONTRACT_JOB_NUM'];?>">
                                    </div>
                                    <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-2">
                                       ...
                                       <input disabled="" name="DATE_POST" type="text" placeholder="" class="form-control" data-mask="99.99.9999" id="DATE_POST" value="<?php echo $empInfo[0]['DATE_POST'];?>">
                                    </div>
                                    <div class="col-lg-2">
                                       <label class="font-noraml">Дата конца работы</label>
                                       <input disabled="" name="DATE_LAYOFF" type="text" placeholder="" class="form-control" data-mask="99.99.9999" id="DATE_LAYOFF" value="<?php echo $empInfo[0]['DATE_LAYOFF'];?>">
                                    </div>
                                    <div class="col-lg-4">
                                       <label class="font-noraml">Статус</label>
                                       <select disabled="" id="STATE" name="STATE" class="select2_demo_1 form-control">
                                          <option></option>
                                          <?php
                                 ...
                                 <div class="row">
                                    <div class="col-lg-3">
                                       ...
                                       <select disabled="" id="BANK_ID" name="BANK_ID" class="select2_demo_1 form-control">
                                          <option></option>
                                          <?php
                                    ...
                                    <div class="col-lg-3">
                                       ...
                                       <input disabled="" name="ACCOUNT_TYPE" type="text" placeholder="" class="form-control" id="ACCOUNT_TYPE" value="<?php echo $empInfo[0]['ACCOUNT_TYPE'];?>">
                                    </div>
                                    <div class="col-lg-3">
                                       <label class="font-noraml">Номер счета</label>
                                       <input disabled="" name="ACCOUNT" type="text" placeholder="" class="form-control" id="ACCOUNT" value="<?php echo $empInfo[0]['ACCOUNT'];?>">
                                    </div>
                                 </div>
                                 <br/>
                                          ...
                                          <table class="table table-hover margin bottom" id="editEduTable">
                                             <thead>
                                                <tr>
                                                   ...
                                                   <th class="text-center">Количество дней за период</th>
                                                   <th class="text-center">Наработно до сегодняшнего дня</th>
                                                   <th class="text-center">Использовано на сегодня</th>
                                                   <th class="text-center">Не наработано дней</th>
                                             ...
                                             <tbody id="place_for_holi2">
                                                <?php
                                                   foreach($list_holy_period as $n => $m)
                                                   {
                                                       ...
                                                       if(strtotime($today_date) < strtotime($m['PERIOD_END']))
                                                       {
                                                           ...
                                                           $avail_day_for_today = round($day_from_period_start/365*30);
                                                       }
                                                ...
                                                <form method="POST">
                                                   <tr>
                                                      ...
                                                      <td class="text-center"><?php echo $avail_day_for_today; ?> дн.</td>
                                                      <td class="text-center"><input class="ui-pg-input" name="DAY_COUNT_USED_FOR_TODAY" value="<?php echo $used; ?>"/></td>
                                                      <td class="text-center"><input class="ui-pg-input" name="DIDNT_ADD" value="<?php echo $didnt_add; ?>"/></td>
                                    ...
                                    <div class="ibox-content">
                                       <div class="row">
                                          <table class="table table-hover margin bottom" id="editEduTable">
                                             ...
                                             <tbody id="place_for_holi2">
                                                <?php
                                                   foreach($list_holi_for_health_paying as $n => $m){
                                                       $state = $m['STATE'];
                                                       $year = $m['YEAR'];
                                                       $option_input = '<select name="PAYING_FOR_HELTH_STATE" class="select2_demo_1 ui-pg-input">
                                                                           <option></option>
                                                       ...
                                                       if($state == '0')
                                                       {
                                                           $option_input = '<select name="PAYING_FOR_HELTH_STATE" class="select2_demo_1 ui-pg-input">
                                                                               <option></option>
                                                                               <option value="1">Использовано</option>
                                                                               <option selected="" value="0">Не использовано</option>
                                                                           </select>';
                                                       }
                                                   ?>
                                                <form method="POST">
                                                   <tr>
                                                      <td hidden=""><input class="ui-pg-input" name="PAYING_FOR_HELTH_YEAR" value="<?php echo $year; ?>"/></td>
                                                      <td class="text-center"><?php echo $year; ?></td>
                                                      <td class="text-center"><?php echo $option_input; ?></td>
                                                      <td class="text-center small">
                                                         <div class="btn-group">
                                                            <button class="btn btn-xs btn-primary">Сохранить</button>
                                                         </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="editable" >
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td></td>
                                             <td>
                                                <input name="IINforFolder" id="IINforFolder" type="text" placeholder="" class="form-control fio" id="fio" value="<?php echo $empInfo[0]['IIN'];?>" style="display: none;"/>
                                                <div class="btn-group">
                                                   <a href="job_contract?employee_id=<?php echo $empId; ?>&bossname=Амерходжаева Г. Т.&bossname_kaz=Амерходжаев Г. Т." target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"> Сгенерировать</i></a>
                                                </div>
                                                <div class="btn-group">
                                                   <a href="just_print?job_contr_employee_id=<?php echo $empId; ?>" target="_blank" type="submit" class="btn btn-sm btn-primary" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"> Распечатать</i></a>
                                                </div>
                                             </td>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td>
                                                <input name="IINforFolder" id="IINforFolder" type="text" placeholder="" class="form-control fio" id="fio" value="<?php echo $empInfo[0]['IIN'];?>" style="display: none;"/>
                                                <div class="btn-group">
                                                   <a href="append_contr?employee_id=<?php echo $empId; ?>&bossname=Амерходжаева Г. Т.&bossname_kaz=Амерходжаев Г. Т." target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"> Сгенерировать</i></a> 
                                                </div>
                                                <div class="btn-group">
                                                   <a href="just_print?append_contr_employee_id=<?php echo $empId; ?>" target="_blank" type="submit" class="btn btn-sm btn-primary" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"> Распечатать</i></a>
                                                </div>
                                             </td>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>5</td>
                                             <td>Приказ о переводе</td>
                                             <td></td>
                                             <td>
                                                <div class="btn-group">
                                                   <a href="emp_history?emp_id=<?php echo $empId; ?>" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>5</td>
                                             <td>Доп. соглашение о выплате ежемесячной премии</td>
                                             <td></td>
                                             <td>
                                                <div class="btn-group">
                                                   <a href="append_contr?employee_id=<?php echo $empId; ?>&dop_num=1" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>5</td>
                                             <td>Договор об обучении сотрудников</td>
                                             <td></td>
                                             <td>
                                                <div class="btn-group">
                                                   <a href="employee_agreement?employee_id=<?php echo $empId; ?>" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>5</td>
                                             <td>Договор о полной индивидуальной материальной ответственности </td>
                                             <td></td>
                                             <td>
                                                <div class="btn-group">
                                                   <a href="agreement_material_respons?employee_id=<?php echo $empId; ?>" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                           <tr>
                                             ...
                                             <td>
                                                <div class="btn-group">
                                                   <a href="supplementary_agreement?employee_id=<?php echo $empId; ?>" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                           <tr>
                                             <td>6</td>
                                             <td>Дополнительное соглашение(в связи с удаленкой) </td>
                                             <td></td>
                                             <td>
                                                <div class="btn-group">
                                                   <a href="dopik_new?employee_id=<?php echo $empId; ?>" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>7</td>
                                             <td>Соглашение о неразглашении конфиденциальной информации</td>
                                             <td></td>
                                             <td>
                                                <div class="btn-group">
                                                   <a href="soglashenie_confident?employee_id=<?php echo $empId; ?>" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                          ...
                                          <tr>
                                             <td>8</td>
                                             <td>Доп соглашение(обновленный)</td>
                                             <td></td>
                                             <td>
                                                <div class="btn-group">
                                                   <a href="dop_soglasheniya?employee_id=<?php echo $empId; ?>" target="_blank" type="submit" onclick="addDocs" id="addDocs" class="btn btn-sm btn-danger" data="<?php echo $v['ID'] ?>"><i class="fa fa-file-pdf-o"></i></a>  
                                                </div>
                                             </td>
                                          </tr>
                                 ...
                                 <table class="table table-hover margin bottom" id="editEduTable">
                                    ...
                                    <tbody id="place_for_trip">
                                       ...
                                       <tr data="<?php echo $m['ID']; ?>">
                                          ...
                                          <td class="text-center small">
                                             <div class="btn-group">
                                                <a data-toggle="modal" data-target="#trip_details" onclick="$('#TRIP_DETAIL_ID').val('<?php echo $m['ID']; ?>');" class="btn-white btn btn-xs">Добавить транспорт</a>
                                                <div class="input-group-btn btn-xs">
                                       ...
                                       <div hidden="" id="head_of_doc">
                                          <div style="text-align: right;">
                                             ...
                                             <div style="text-align: center;">
                                                <strong>
                                                   <h3>ТАБЕЛЬ УЧЕТА РАБОЧЕГО ВРЕМЕНИ С <?php echo $timesheet_date_start; ?> ПО <?php echo $timesheet_date_end; ?></h3>
                                                </strong>
                                             </div>
                                             <div style="text-align: center;">
                                                <strong>
                                                   <h3><?php echo $dep_name; ?></h3>
                                                </strong>
                                             </div>
                                             <hr/>
                                          </div>
                           ...
                           <div id="tab-9" class="tab-pane">
                              ...
                              <div class="panel-body">
                                 <h3>Обучение</h3>
                                 <a data-toggle="modal" data-target="#add_trainig" class="btn btn-primary btn-xs">Добавить обучение</a>
                                 <table class="table table-hover margin bottom" id="editEduTable">
                                    <thead>
                                       <tr>
                                          <th class="text-center">Дата начала обучение</th>
                                          <th class="text-center">Дата конца обучение</th>
                                          <th class="text-center">Количество дней</th>
                                    ...
                                    <tbody id="place_for_trip">
                                       <?php
                                          foreach($list_train as $n => $m){
                                              $train_id = $m['ID'];
                                          ?>
                                       <tr data="<?php echo $m['ID']; ?>">
                                          <td class="text-center"><?php echo $m['DATE_BEGIN']; ?></td>
                                          <td class="text-center"><?php echo $m['DATE_END']; ?></td>
                                          <td class="text-center"><?php echo $m['CNCT_DAY']; ?></td>
                                          <td class="text-center small"><?php echo $m['NAME']; ?></td>
                                          <td class="text-center small"><?php echo $m['SUM']; ?></td>
                                          <td class="text-center small"><?php echo $m['LOCATION']; ?></td>                                         
                                          <td class="text-center small">
                                             <div class="btn-group">                                               
                                                <div class="input-group-btn btn-xs">
                                                   <a target="_blank" href="employee_agreement?employee_id=<?php echo $m['ID_PERSON']; ?>&&pt_id=<?php echo $m['ID']; ?>" class="btn btn-white btn-xs" type="button">Печать приказа</a>                                                  
                                                </div>
                                             </div>
                                          </td>
                                       </tr>
                           ...
                           <div id="tab-11" class="tab-pane">
                              <div class="panel-body">
                                 <h3>Подписанты в договорах ,в отпусках</h3>                                 
                                 <table class="table table-hover margin bottom" id="editEduTable">
                                    <thead>
                                       <tr>
                                          <th class="text-center">Позиция должности</th>
                                    ...
                                    <tbody id="place_for_trip">
                                      <?php
                                        foreach($list_signer as $n => $m){
                                                       $state = $m['PODPIS_ID'];
                                                       $year = $m['THIS_YEAR'];
                                                       $osnovanie = $m['OSNOVANIE'];
                                                       if($osnovanie == 1){
                                                        $osnovanie = 2;
                                                       }
                                                       else{
                                                       ...
                                                       $option_input = '<select name="PODPISANT" class="select2_demo_1 ui-pg-input">
                                                                           <option></option>
                                                                           <option selected="" value="527">Касимова Д</option>
                                                       ...
                                                       if($state == '315')
                                                       {
                                                           $option_input = '<select name="PODPISANT" class="select2_demo_1 ui-pg-input">
                                                                               ...
                                                                               <option selected="" value="315">Амерходжаев Г</option>
                                                                           </select>';
                                                       }
                                                   ?>
                                       <form method="POST">                  
                                       <tr data="<?php echo $m['ID']; ?>">
                                       <td hidden=""><input class="ui-pg-input" name="osnovanie" value="<?php echo $osnovanie; ?>"/></td>
                                          <td class="text-center"><input name="position_podpis" readonly="" value="<?php echo $m['JOB_POSITION']; ?>" /></td>
                                          <td class="text-center"><?php echo $option_input; ?></td>
                                         <td class="text-center small">
                                                         <div class="btn-group">
                                                            <button class="btn btn-xs btn-primary">Сохранить</button>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title">Отозвать с дкретного отпуска</h4>
         </div>
         ...
         <div class="modal-body">
            <form method="post">
               ...
               <div class="form-group" id="data_1">
                  ...
                  <select onchange="show_holy_days();" name="HOLY_KIND" id="HOLY_KIND" class="select2_demo_1 form-control">
                     <option></option>
                     <?php
               ...
               <div class="form-group" id="paying_for_health_period" hidden="">
                  <select name="YEAR_FOR_HEALTH_PAYING_PERIOD" id="YEAR_FOR_HEALTH_PAYING_PERIOD" class="select2_demo_1 form-control">
                     <option></option>
                     <option id="О" value="2017">2017</option>
                     <option id="О" value="2018">2018</option>
                     <option id="О" value="2019">2019</option>
                      <option id="О" value="2020">2020</option>                     
                  </select>
               </div>
               <script>
                  ...
                  function show_period(sel_num)
                  {
                      ...
                      if(sel_num == '1')
                      {
                          $('#paying_for_health_period').show();
                      }
                          else
                      {
                          $('#paying_for_health_period').hide();
                      }
...
<!-- MODAL WINDOWS -->            
<div class="modal inmodal fade" id="add_trainig" tabindex="-1" role="dialog"  aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title">Добавление обучение</h4>
            <small class="font-bold">обучение</small>
         </div>
         <div class="modal-body">
            <form method="post">
               <div hidden="" class="form-group" id="data_1">
                  <input name="ID_PERSONtrain" type="text" placeholder="" class="form-control" id="ID_PERSONtrain" value="<?php echo $empId; ?>">
               </div>
               <div class="form-group">
                  <label class="font-noraml">Дата начала обучение</label>
                  <div class="input-group date">
                     <span class="input-group-addon">
                     <i class="fa fa-calendar"></i>
                     </span>
                     <input type="text" class="form-control dateOform" name="DATE_BEGINtrain" data-mask="99.99.9999" id="DATE_BEGINtrain" required/>
                  </div>
               </div>
               <div class="form-group">
                  <label class="font-noraml">Дата конца обучение</label>
                  <div class="input-group date">
                     <span class="input-group-addon">
                     <i class="fa fa-calendar"></i>
                     </span>
                     <input type="text" class="form-control dateOform" name="DATE_ENDtrain" data-mask="99.99.9999" id="DATE_ENDtrain" required/>
                  </div>
               </div>
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Название курса (рус)</label>
                  <input type="text" class="form-control dateOform" name="NAME_TRAIN"  id="NAME_TRAIN" required/>
               </div>   
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Название курса (каз)</label>
                  <input type="text" class="form-control dateOform" name="NAME_TRAIN_KAZ"  id="NAME_TRAIN_KAZ" required/>
               </div>                                          
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Количество дней</label>
                  <input name="CNT_DAYtrain" type="text" placeholder="" class="form-control" id="CNT_DAYtrain" value="" required>
               </div>
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Сумма (тенге)</label>
                  <input name="SUM_TRAIN" type="number" placeholder="" class="form-control pos_btn" id="SUM_TRAIN" value="">
               </div>
              <div class="form-group" id="data_1">
               <label class="font-noraml">Местоположение обучение (рус)</label>
               <select id="ADRESS_TRAIN" name="ADRESS_TRAIN" class="select2_demo_1 form-control">
                                             <option></option>
                             ...
                             <div class="form-group" id="data_1">
               <label class="font-noraml">Местоположение обучение (каз)</label>
               <select id="ADRESS_TRAIN_KAZ" name="ADRESS_TRAIN_KAZ" class="select2_demo_1 form-control">
                                             <option></option>
                                             <option>Нұр-Сұлтан</option>
                                             <option>Алматы</option>
                                             <option>Мәскеу</option>                                             
                                             </select>
               </div>
               
         </div>
         <div class="modal-footer">
         <a onclick="addTrain();" type="submit" class="btn btn-primary" data-dismiss="modal">Сохранить</a>
         <a type="button" class="btn btn-white" data-dismiss="modal">Закрыть</a>
         </div>
         </form>
      </div>
...
<script>
   function addHolidayFunc()
   {
           ...
           if(ID_PERSONholi != '' && DATE_BEGINholi != '' && DATE_ENDholi != '' && CNT_DAYSholi != '' && PERIOD_BEGINholi != '' && PERIOD_ENDholi != '' && ORDER_NUMholi != '' && ORDER_DATEholi != '' && BRANCH_IDholi != '' && JOB_SPholi != '' && JOB_POSITIONholi != '' && AUTHOR_ID != '' && today_date != '' && HOLY_KIND != '')
           {
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form method="post">
               <div hidden="" class="form-group" id="data_1">
                  <input name="ID_PERSONhospEdit" type="text" placeholder="" class="form-control" id="ID_PERSONhospEdit" value="<?php echo $empId; ?>">
               </div>
               <div hidden="" class="form-group" id="data_1">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form method="post">
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Филиал</label>
                  <select onchange="" name="BRANCHID_view" id="BRANCHID_view" class="select2_demo_1 form-control pos_btn">
                     <option value="0"></option>
                     <?php
                        foreach($listBranch as $r => $t){
                        ?>
                     <option  value="<?php echo trim($t['RFBN_ID']); ?>"><?php echo $t['NAME']; ?></option>
                     <?php
                        }
                        ?>
                  </select>
               ...
               <div class="form-group" id="data_1">
                  ...
                  <select onchange="get_positions();" name="JOB_SP_view" id="JOB_SP_view" class="select2_demo_1 form-control pos_btn" id="JOB_SP_DIV">
                     <option value="0"></option>
                  </select>
               </div>
               <div class="form-group" id="data_1">
                  ...
                  <div id="place_for_job_pos">
                     <select onchange="" name="JOB_POSITION_view" id="JOB_POSITION_view" class="select2_demo_1 form-control pos_btn">
                        <option value="0"></option>
                     </select>
                  </div>
               </div>
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Руководитель</label>
                  <input disabled="" name="ID_RUKOV_VIEW" placeholder="" class="form-control" id="ID_RUKOV_VIEW" value="<?php echo $p['ID_RUKOV']; ?>" style="display: none;">
                  <input disabled="" name="ID_RUKOV_MOD" placeholder="" class="form-control" id="ID_RUKOV_MOD" value="<?php echo $p['ID_RUKOV']; ?>">
               </div>
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Оклад (тенге)</label>
                  <input name="OKLAD_view" type="number" placeholder="" class="form-control pos_btn" id="OKLAD_view" required=""/>
               </div>
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Номер приказа</label>
                  <input name="ORDER_NUM_CHAGE_POS" placeholder="" class="form-control pos_btn" id="ORDER_NUM_CHAGE_POS" required=""/>
               </div>
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Дата (приказа)</label>
                  <div class="input-group date">
                     ...
                     <input type="text" class="form-control dateOform" name="ORDER_TO_TRANSFER_DATE" data-mask="99.99.9999" id="ORDER_TO_TRANSFER_DATE" required=""/>
                  </div>
               </div>
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Дата вступления в силу</label>
                  <div class="input-group date">
                     <span class="input-group-addon">
                     <i class="fa fa-calendar"></i>
                     </span>
                     <input type="text" class="form-control dateOform" name="EVENT_START_DATE" data-mask="99.99.9999" id="EVENT_START_DATE" required=""/>
                  </div>
               </div>
         </div>
         <div class="modal-footer">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form method="post">
               ...
               <div class="form-group" id="data_1">
                  <label class="font-noraml">Причина увольнения</label>
                  <select id="REASON_LAYOFF" name="REASON_LAYOFF" class="select2_demo_1 form-control" required="">
                     <option></option>
                     <?php
                        foreach($list_layoff_reason as $b => $s)
                        {
                        ?>
                     <option value="<?php echo $s['ID']; ?>"><?php echo $s['REASON_NAME']; ?></option>
                     <?php 
                        }
                        ?>
                  </select>
               ...
               <hr />
               <small>Прежде чем уволнять, взгляните на обучение сотрудника</small>
               <div class="form-group" id="data_1">
                                                <div class="ibox float-e-margins collapsed">
                                    <div class="ibox-title">
                                       <h5 class="font-noraml">обучение сотрудника</h5>
                                       <div class="ibox-tools">
                                          <a class="collapse-link">
                                          <i class="fa fa-chevron-up"></i>
                                          </a>
                                    ...
                                    <div class="ibox-content">
                                       <div class="row">
                                          <table class="table table-hover margin bottom" id="editEduTable">
                                             ...
                                             <?php $list_p_t = $db->select("select * from PERSON_TRAINING where id_person = $empId"); 
                                             foreach($list_p_t as $k=>$v)
                                             {
                                             ?>
                                             <tbody id="place_for_holi2">                                                                                          
                                                   <tr>                                                      
                                                      ...
                                                      <td class="text-center"><?php echo $v['SUM']; ?></td>                                                     
                                                   </tr>                                                                                              
                                             </tbody>
                                             <?php } ?>
                                          </table>
...
<script>
   ...
   // для обучения
      $('#CNT_DAYtrain').click(
       function(){
           var date1 = $('#DATE_BEGINtrain').val();
           var date2 = $('#DATE_ENDtrain').val();
           var day = count_difftrain(date1, date2);
           var daycount = day + 1;
           $('#CNT_DAYtrain').val(daycount);
       }
   )
   
   function count_difftrain(d1, d2){
       var date_1 = new Date(parseInt(d1.substr(6, 4), 10), parseInt(d1.substr(3, 2), 10), parseInt(d1.substr(0, 2), 10));
       var date_2 = new Date(parseInt(d2.substr(6, 4), 10), parseInt(d2.substr(3, 2), 10), parseInt(d2.substr(0, 2), 10));
       return Math.abs(((date_1-date_2)/86400000));;
   }
   ...
   function correct_selects_sp(BRANCHID)
       {
           ...
           if(BRANCHID == '0')
           {
               $('#JOB_SP_view').html('<option value="0" selected="selected">Филиал</option>');
               ...
               else if(BRANCHID == '0000')
           {
               ...
               $.post
                   ('edit_employee', 
                       {
                           "GET_CHIEF_NAME_ID": "GET_CHIEF_NAME_ID",
                           "BRANCHID_CHIEF_NAME": BRANCHID
                       }, 
                           function(d)
                       {
                           $('#ID_RUKOV_MOD').val(d.trim());
                       }
                   )
           }
               else
           {
               ...
               $.post
                   ('edit_employee', 
                       {
                           "BRANCHID_FOR_JOB_POSITION": BRANCHID
                       }, 
                           function(d)
                       {
   ...
   function get_positions(){
       ...
       {
                   $('#place_for_job_pos').html('<select name="JOB_POSITION_view" id="JOB_POSITION_view" class="select2_demo_1 form-control"><option value="0" selected></option></select>');
   ...
   function(){
       ...
       var emp_id = $('#empIdTrivial').val();
       var ORDER_NUM_CHAGE_POS = $('#ORDER_NUM_CHAGE_POS').val();
       ...
       if(OKLAD == '')
           ...
           else
           {
               ...
               $('#OKLAD').val(OKLAD);
               build_position(BRANCHID, JOB_SP, JOB_POSITION, OKLAD, ID_RUKOV, emp_id, ORDER_TO_TRANSFER_DATE, ORDER_NUM_CHAGE_POS, EVENT_START_DATE);
           }
   })

   function build_position(BRANCHID, JOB_SP, JOB_POSITION, OKLAD, ID_RUKOV, emp_id, ORDER_TO_TRANSFER_DATE, ORDER_NUM_CHAGE_POS, EVENT_START_DATE)
   {
       $.post
       ('edit_employee',
           {
               ...
               "OKLAD": OKLAD,
               "emp_id": emp_id,
               "ORDER_NUM_CHAGE_POS": ORDER_NUM_CHAGE_POS,
