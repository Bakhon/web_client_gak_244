<?php 
    ...
    if($_SESSION['insurance']['other']['mail'][0] != 'i.akhmetov@gak.kz')
    {
        if($_SESSION['insurance']['other']['mail'][0] != 'a.ibrayeva@gak.kz')
        {
            ...
            {
                if($_SESSION['insurance']['other']['mail'][0] != 'a.nuryshova@gak.kz')
                {
                        ...
                        if($_SESSION['insurance']['other']['mail'][0] != 'a.adilkhankyzy@gak.kz')
                    {
                        ...
                        {
                                echo '<h1>У Вас нет прав на просмотр данной страницы! </h1>';
                                exit;
                        }
                    }
                 }
                    ...
                    <form method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group" id="search_pers_btn">
                                <a data-toggle="modal" data-target="#search_pers" type="button" class="btn btn-primary btn-sm">Поиск в базе физ.лиц Казахстана</a>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="font-noraml">Департамент *</label>
                                <select onchange="get_positions();" name="JOB_SP" id="JOB_SP" class="select2_demo_1 form-control" required/>
                                    <option></option>
                                </select>
                            </div>
                            <div class="form-group" id="data_1">
                            <label class="font-noraml">Должность *</label>
                                <div id="place_for_job_pos">
                                    <select name="JOB_POSITION" id="JOB_POSITION" class="select2_demo_1 form-control" required/>
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="data_1">
                                ...
                                <select name="nationality" class="select2_demo_1 form-control chosen-select" required>
                                    <option></option>
                                    <?php
                            ...
                            <div class="form-group" id="data_1">
                                ...
                                <select name="FACT_ADDRESS_COUNTRY_ID" class="select2_demo_1 form-control chosen-select" required>
...
<script>
    function create_mail()
    {
        ...
        $('#PERSONAL_EMAIL').val(firstnames_firs_simb+'.'+lastname+'@gak.kz');
    }
</script>
