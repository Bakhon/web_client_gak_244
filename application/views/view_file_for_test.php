            ...
            <div class="mail-box">
                ...
                <form enctype="multipart/form-data" class="form-horizontal" method="POST" id="main_form">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Вид:</label>
                        <div class="col-sm-10">
                            <select class="select2_demo_1 form-control" name="KIND" id="KIND">
                                <option></option>
                                <?php 
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Destination</label>
                        <div class="col-sm-10">
                            <input class="form-control" id="DESTINATION" name="DESTINATION" value="1"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Согласующие <br />(при последовательном согласовании, выбирайте адресаты в порядке их очереди на согласование):</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Получатель:</label>
                        <div class="col-sm-10">
                            <select name="RECIPIENT[]" id="RECIPIENT" data-placeholder="Несколько получателей..." class="chosen-select col-lg-12" multiple>
                                <option></option>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Дата написания:</label>
                        <div class="col-sm-10"><input readonly="" type="text" class="form-control" value="<?php echo $today_date; ?>" id="DATE_START" name="DATE_START"/></div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Заголовок:</label>
                        <div class="col-sm-10"><input type="text" class="form-control" id="HEAD_TEXT" name="HEAD_TEXT" value=""/></div>
                    </div>
                    <div hidden="" class="form-group"><label class="col-sm-2 control-label">Отправитель:</label>
                        <div class="col-sm-10"><input class="form-control" value="<?php echo $emp_fio; ?>" id="SENDER" name="SENDER" readonly=""/></div>
                    </div>
                    <div hidden="" class="form-group"><label class="col-sm-2 control-label">Отправитель email:</label>
                        <div class="col-sm-10"><input class="form-control" value="<?php echo $emp_mail; ?>" id="SENDER_MAIL" name="SENDER_MAIL" readonly=""/></div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label">Краткое содержание:</label>
                        <div class="col-sm-10"><input type="text" class="form-control" value="" id="SHORT_TEXT" name="SHORT_TEXT"/></div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Дата ответа:</label>
                        <div class="col-sm-10">
                            <div class="input-group date ">
                                ...
                                <input type="text" class="form-control dateOform" name="DATE_END" data-mask="99.99.9999" id="DATE_END"/>
                            </div>
                        </div>
                    </div>
