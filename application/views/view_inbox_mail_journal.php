                        ...
                        <table style="width:100%; " class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: #1c84c6;">Дата поступления</th>
                                    <th colspan="2" style="color: #23c6c8;">Корреспондент, дата и индекс <br /> входящего документа</th>
                                    <th style="color: #1c84c6;">Вид документа, заголовок или <br /> краткое содержание входящего документа</th>
                                    <th style="color: #ed5565;">Резолюция или кому направлен <br /> документ на исполнение</th>
