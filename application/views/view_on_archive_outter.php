                                ...
                                <table class="table table-striped table-bordered table-hover" id="editable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="read">
                                            ...
                                            <td class="mail-subject"><a href="mail_detail_just_read?doc_id=<?php echo $v['MAIL_ID']; ?>&get_file=<?php echo $v['DOC_LINK'];?>&rec_id=<?php echo $v['ID'];?>&dest_id=<?php echo $v['DESTINATION'];?>&step_id=<?php echo $v['CURRENT_STEP_ID'];?>&next_step_id=<?php echo $v['NEXT_STEP_ID'];?>&state_id=8&prev_step_id=<?php echo $v['PREV_STEP_ID'];?>"><?php echo $v['DATE_END']; ?></a></td>
                                            <td class="mail-subject"><a href="mail_detail_just_read?doc_id=<?php echo $v['MAIL_ID']; ?>&get_file=<?php echo $v['DOC_LINK'];?>&rec_id=<?php echo $v['ID'];?>&dest_id=<?php echo $v['DESTINATION'];?>&step_id=<?php echo $v['CURRENT_STEP_ID'];?>&next_step_id=<?php echo $v['NEXT_STEP_ID'];?>&state_id=8&prev_step_id=<?php echo $v['PREV_STEP_ID'];?>"><?php echo $v['DATE_START']; ?></a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
