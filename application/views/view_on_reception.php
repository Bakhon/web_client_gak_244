                        ...
                        <div class="ibox-content">
                            <table class="table table-striped table-bordered table-hover" id="editable">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr class="read">
                                        <td class="mail-subject"><a href="mail_detail_draft?doc_id=<?php echo $v['MAIL_ID']; ?>&get_file=<?php echo $v['MAIL_ID'];?>&draft_mail_id=<?php echo $v['MAIL_ID'];?>"><?php echo $v['ID']; ?></a></td>
                                        ...
                                        <td class="mail-subject"><a href="mail_detail_draft?doc_id=<?php echo $v['MAIL_ID']; ?>&get_file=<?php echo $v['MAIL_ID'];?>&draft_mail_id=<?php echo $v['MAIL_ID'];?>"><?php echo $v['NAME_KIND']; ?></a></td>
