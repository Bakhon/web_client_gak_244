<div class="row">
    <div class="col-lg-12" id="osn-panel">
       <div class="ibox-title"><h3 align="center">Результаты проектов</h3>
       </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="editable">
                ...
                <tbody>
                    <?php foreach($list_project as $k => $v){
                        ?>
                    <tr ondblclick="$(location).attr('href','res_full?project_id=<?php echo $v['ID']; ?>');" class="gradeX view_user_dan" data="<?php ?>" style="cursor: default;">
                        <td>
                            <?php echo $v['ID'];?>
                        </td>
