                ...
                <div class="ibox-content">
                    <div class="project-list">
                        ...
                        <span class="pull-right">
                            <a target="_blank" href="site_blog_arc" class="btn btn-warning btn-xs"><i class="">История изменений</i></a>
                        </span>  
                        ...
                        <button data-toggle="modal" data-target="#add_slide" type="submit" class="btn btn-md btn-primary" ><i class="fa fa-plus-square"></i> Добавить пост </button>
                    </div>
                </div>
            </div>
        </div>
