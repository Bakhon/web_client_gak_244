            ...
            <form method="post">                           
                ...
                <?php            
                 ...
                 $q = $db->Select("select * from sup_person where email = '$em'");
                  ...
                  $id_user = $db->id_user = $q[0]['ID']; ?>
                <input type="hidden" name="emp_id_upd" value="<?php echo $id_user;?>"/>
                    ...
                    <div class="form-group" id="data_1">
                        <label>                                    
                          <input  name="IS_MAIN" id="IS_MAIN" <?php if($v['IS_MAIN'] == '1') { ?> value="" checked="checked" <?php } else { ?> value="0"  <?php } ?> type="checkbox"/>
                          <small>Опубликовать на главную страницу</small>                                  
                        </label>   
                    </div>
