    ...
    <div class="row">
        <div class="col-lg-12 animated fadeInRight">
            <div class="ibox">
                ...
                <input type="hidden" name="emp_update" value="<?php echo $id_user;?>"/>
        ...
        <div class="modal-content modal-lg">
            ...
            <form method="post">
                ...
                <input type="hidden" name="emp_id" value="<?php echo $id_user;?>"/>
                    ...
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">Текст кнопки Eng:</label>
                        <input name="BTN_TEXT_ENG" placeholder="" class="form-control" id="BTN_TEXT_ENG" type="text"/>
                    </div>
                    <hr />
                    <div class="form-group" id="data_1">
        ...
        <div class="modal-content modal-lg">
            ...
            <form method="post">
                ...
                <input type="hidden" name="upd" value="<?php echo $id_user;?>"/>               
                    ...
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">URL кнопки</label>
                        <input name="BTN_URL_UPD" placeholder="" class="form-control" id="BTN_URL_UPD" value="<?php echo $v['BTN_URL']; ?>" type="text">
                    </div>
                    <div class="form-group" id="data_1">
