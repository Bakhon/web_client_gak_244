                ...
                <div class="ibox-content">
                    <div class="project-list">
                        ...
                        <span class="pull-right">
                            <a target="_blank" href="site_questions_arc" class="btn btn-warning btn-xs"><i class="">История изменений</i></a>
                        </span> 
                        ...
                        <button data-toggle="modal" data-target="#add_slide" type="submit" class="btn btn-md btn-primary" ><i class="fa fa-plus-square"></i> Добавить вопрос </button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal inmodal fade" id="edit_slide<?php echo $v['ID']; ?>" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg" style="float: left; left: 18%;">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"></span><span class="sr-only">Close</span></button>
                <div id="closeModal"><h4 class="modal-title">Форма редактирования вопроса</h4></div>
                <small class="font-bold"></small>
            </div>
            <form method="post">
                <div class="modal-body">
                <?php            
                 ...
                 $q = $db->Select("select * from sup_person where email = '$em'");
                  ...
                  $id_user = $db->id_user = $q[0]['ID']; ?>
                <input type="hidden" name="emp_upd" value="<?php echo $id_user;?>"/>
                    ...
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">Заголовок вопроса каз</label>
                        <input name="SLIDE_HEAD_KAZ_UPD" placeholder="" class="form-control" id="SLIDE_HEAD_KAZ_UPD" value="<?php echo $v['ITEM_NAME_KAZ']; ?>" type="text">
                    </div>
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">Текст ответа каз</label>
                        <textarea style="height: 100px;" name="SLIDE_TEXT_KAZ_UPD" class="form-control" id="SLIDE_TEXT_KAZ_UPD"><?php echo $v['CONTENT_KAZ']; ?></textarea>
                    </div>
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">Заголовок вопроса рус</label>
                        <input name="SLIDE_HEAD_RU_UPD" placeholder="" class="form-control" id="SLIDE_HEAD_RU_UPD" value="<?php echo $v['ITEM_NAME_RU']; ?>" type="text">
                    </div>
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">Текст ответа рус</label>
                        <textarea style="height: 100px;" name="SLIDE_TEXT_RU_UPD" class="form-control" id="SLIDE_TEXT_RU_UPD"><?php echo $v['CONTENT_RU']; ?></textarea>
                    </div>
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">Заголовок вопроса англ</label>
                        <input name="SLIDE_HEAD_ENG_UPD" placeholder="" class="form-control" id="SLIDE_HEAD_ENG_UPD" value="<?php echo $v['ITEM_NAME_ENG']; ?>" type="text">
                    </div>
                    <div class="form-group" id="data_1">
                        <label class="font-noraml">Текст ответа англ</label>
                        <textarea style="height: 100px;" name="SLIDE_TEXT_ENG_UPD" class="form-control" id="SLIDE_TEXT_ENG_UPD"><?php echo $v['CONTENT_ENG']; ?></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" id="save" class="btn btn-success">Сохранить</button>
