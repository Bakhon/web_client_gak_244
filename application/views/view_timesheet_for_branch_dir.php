                        ...
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div <?php if($mail != 'i.akhmetov@gak.kz' and $mail != 'b.abdisamat@gak.kz'){echo 'hidden=""';} ?> class="col-md-3">
                                <dl class="dl-horizontal">
                                    <dt>Департамент:</dt>
                                <dd>
                                <input value="0" type="text" class="form-control dateOform" name="dep_id_for_table" id="dep_id_for_table" required=""/>
                                </dd>
                                </dl>
                            </div>
                            <div <?php if($mail != 'i.akhmetov@gak.kz' and $mail != 'b.abdisamat@gak.kz'){echo 'hidden=""';} ?> class="col-md-3">
            ...
            <div class="modal-content animated flipInY">
                ...
                <div class="modal-body">
                    ...
                    <div hidden="" class="input-group" style="display: none;">
                        <input value="<?php echo $branch_id; ?>" type="text" class="form-control dateOform" name="branch_id_mis" id="branch_id_mis" required/>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <div hidden="" class="input-group" style="display: none;">
                        <input value="0000" type="text" class="form-control dateOform" name="dep_id_for_table_up" id="dep_id_for_table_up" required/>
                    </div>
                    <div hidden="" class="input-group" style="display: none;">
            ...
            <form method="post">
                    ...
                    <div class="form-group" id="data_1">
                        ...
                        <select onchange="" name="MISS_PERSON_ID" id="MISS_PERSON_ID" class="select2_demo_1 form-control">
                            <option></option>
                            <?php
                                foreach($list_branch_guys as $k => $l){
                            ?>
