                ...
                <div class="ibox-tools">
                    <form method="POST">
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div <?php if($mail != 'i.akhmetov@gak.kz' and $mail != 'b.abdisamat@gak.kz' ){echo 'hidden=""';} ?> class="col-md-3">
            ...
            <div class="ibox-content">
                <div class="table-responsive" id="table_with_data">
                    <table class="table table-hover" >
                        <thead>
                            <tr>
                                <th style="color: black;">ФИО</th>
                                <th style="color: black;">Должность</th>
                                <?php
                                foreach($list_guy as $b => $d)
                                {
                                    echo '<th style="color: black;">'.$d['WEEK_DAY'].'</th>';
                                }
                                ?>
                                <th style="color: black;">Дни</th>
                                <th style="color: black;">Часы</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
                            foreach($list_guys as $k => $v)
                            {
                                ...
                                {
                                        if
                                        ($z['VALUE'] == 'А'){$color = " style='color: black; cursor: pointer; border: 1px solid #18a689; background-color:#dff0d8'";}else if
                                        ($z['VALUE'] == 'О'){$color = " style='color: black; cursor: pointer; border: 1px solid #18a689; background-color:#fcf8e3'";}else if
                                        ($z['VALUE'] == 'Б'){$color = " style='color: black; cursor: pointer; border: 1px solid #18a689; background-color:#d9edf7'";}else if
                                        ($z['VALUE'] == 'П'){$color = " style='color: black; cursor: pointer; border: 1px solid #18a689; background-color:#bce8f1'";}else if
                                        ...
                                        ($z['VALUE'] == ' '){$color = " style='color: black; cursor: pointer; border: 1px solid #18a689; background-color:#2f4050'";}else if
                                        ($z['VALUE'] == '2'){$hours = $hours+2; $days = $days+1; $color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}else if
                                        ($z['VALUE'] == '3'){$hours = $hours+3; $days = $days+1; $color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}else if
                                        ($z['VALUE'] == '4'){$hours = $hours+4; $days = $days+1; $color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}else if
                                        ($z['VALUE'] == '5'){$hours = $hours+5; $days = $days+1; $color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}else if
                                        ($z['VALUE'] == '6'){$hours = $hours+6; $days = $days+1; $color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}else if
                                        ($z['VALUE'] == '7'){$hours = $hours+7; $days = $days+1; $color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}else if
                                        ($z['VALUE'] == '12'){$hours = $hours+12; $days = $days+1; $color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}else if
                                        ($z['VALUE'] == 'В'){$color = " style='color: black; cursor: pointer; border: 1px solid #18a689; background-color:#9cdacd'";}else
                                        {$hours = $hours+8; $days = $days+1;$color = " style='color: black; cursor: pointer; border: 1px solid #18a689'";}
...
<!--
Руководитель Cлужбы по управлению персоналом 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
