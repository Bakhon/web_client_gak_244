<div class="row">        
    <div class="col-lg-8">
      ...
      <?php foreach($list_clauses as $k=>$v) { if($v['SUCCESS'] == '0'  and $list_executor[0]['EMP_ID'] == true) { ?>
    <div class="col-lg-4">
    <form action="zayavka?get_file=<?php echo $v['ID']; ?>" method="post">
        ...
        <div class="panel-body">
                <textarea name="text_sender" rows="5" wrap="virtual" maxlength="100" class="form-control"></textarea>                                
        </div>
        <center><input type="submit" value="Выполнить" class="btn btn-success btn-lg btn-block"/></center>   
        </div>     
        </form>
        <br />
    ...
    <?php } if($v['SUCCESS'] == '1'  and $list_executor[0]['EMP_ID'] == true) { ?>
    <div class="col-lg-4">
    <div class="panel panel-success">
                <div class="panel-heading">
                  <h3 class="panel-title">Заявка выполнено, ожидайте подтверждение отправителем</h3>
                </div>
                <div class="panel-body">
                  ...
                  <br />
                  Комментарий исполнителя: <br />
                  <strong><?php echo $list_executor[0]['TEXT'];  ?></strong>
    ...
    <?php } if($v['SUCCESS'] == '3'  and $list_executor[0]['EMP_ID'] == true) { ?>  
    <div class="col-lg-4">
    <div class="panel panel-success">
                <div class="panel-heading">
                ...
                <div class="panel-body">
                  ...
                  <strong><?php echo $v['TEXT_COMMENT']; ?></strong>
   ...
   <?php } if($v['SUCCESS'] == '4'  and $list_executor[0]['EMP_ID'] == true) { ?>
  <div class="col-lg-4"> 
   <div class="panel panel-danger">
                <div class="panel-heading">
                  <h3 class="panel-title">Отклонено отправителем</h3>
                </div>
                <div class="panel-body">
                  ФИО Исполнителя: <br />
                  <b><?php echo $list_sp[0]['LASTNAME'].' '.$list_sp[0]['FIRSTNAME']; ?></b><br />  
        ...
        <form action="" method="post" class="form-horizontal">
        <input type="hidden" name="retake" value="" />
        <input type="hidden" name="retake_zayavka" value="<?php echo $v['ID']; ?>" />   
        <br />             
        
        <div class="panel panel-default">                     
            <input type="submit" value="Переделать заявку" class="btn btn-success btn-lg btn-block"/>
        </div>                          
        </form>
   ...
   <?php } if($v['SUCCESS'] == '2'  and $list_executor[0]['EMP_ID'] == true) { ?>
  <div class="col-lg-4"> 
   <div class="panel panel-danger">
                <div class="panel-heading">
