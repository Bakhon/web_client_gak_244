...
class RtfElement
  ...
  class RtfHtml
  {
    ...
    protected function FormatControlWord($word)
    {
      ...
      //Text Align
      }elseif($word->word == "ql"){     //left
        //$this->CloseTags();
        $this->OpenTag('div style="text-align: left;"');
      }elseif($word->word == "qr"){     //right
        //$this->CloseTags();
        $this->OpenTag('div style="text-align: right;"');
      }elseif($word->word == "qj"){     //justified
        //$this->CloseTags();
        $this->OpenTag('div style="text-align: justify;"');
      }elseif($word->word == "qc"){     //centered
        //$this->CloseTags();
        $this->OpenTag('div style="text-align: center;"');
