        ...
        */
        ...
        private function edit($id)
        {
            ...
            if($id > 0){
                ...
                $sql = "select lastname||' '||firstname||' '||middlename fio, iin,
                case when resident = 0 then 'Резидент' else 'Не Резидент' end resident,
                country_name(id_country) countryname  
                from CONTR_AGENTS_FIO where id_insur = $id and id_type = 4";
                $this->dan['BENEFIC'] = $this->db->Select($sql);
            }
