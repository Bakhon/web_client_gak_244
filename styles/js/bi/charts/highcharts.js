...
(function() {
    ...
    function Ja(a, b) {
        if (Pc)
            if (b && b.opacity !== Wa) b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        sa(a.style, b)
    }
    ...
    function Nd(a, b) {
        function c(p) {
                ...
                if (D) {
                    ...
                    for (t = 0; t < F.length; t++) {
                        ...
                        aa =
                            O[2];
                        if (F[t + 1])
                            if (Ta <= (S * aa[aa.length - 1] + F[t + 1][1]) / 2) break
                    }
            ...
            function Ma() {
                ...
                if (!xa)
                    for (k in s)
                        for (n in s[k]) s[k][n].cum = s[k][n].total;
            ...
            var pd, Pb = [],
                ...
                je = o.labels.formatter || function() {
                    var k = this.value;
        ...
        Gc = function() {
            ...
            if ((l.title || l.subtitle) && !K(y))
                if (ta = Ia(l.title && !uc.floating && !uc.verticalAlign && uc.y || 0, l.subtitle && !Ic.floating && !Ic.verticalAlign && Ic.y || 0)) ea = Ia(ea, ta + A(uc.margin, 15) + Na);
