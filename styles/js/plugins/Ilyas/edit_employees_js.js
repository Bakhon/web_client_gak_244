    ...
    function addTripFunc(){
        ...
        function addTrain(){
        var ID_PERSONtrain = $('#ID_PERSONtrain').val();
        var DATE_BEGINtrain = $('#DATE_BEGINtrain').val();
        var DATE_ENDtrain = $('#DATE_ENDtrain').val();
        var NAME_TRAIN = $('#NAME_TRAIN').val();
        var NAME_TRAIN_KAZ = $('#NAME_TRAIN_KAZ').val();
        var CNT_DAYtrain = $('#CNT_DAYtrain').val();
        var SUM_TRAIN = $('#SUM_TRAIN').val();
        var ADRESS_TRAIN = $('#ADRESS_TRAIN').val();
        var ADRESS_TRAIN_KAZ = $('#ADRESS_TRAIN_KAZ').val();
                
        //console.log(ID_PERSONtrip+'/'+DATE_BEGINtrip+'/'+DATE_ENDtrip+'/'+CNT_DAYStrip+'/'+ORDER_NUMtrip+'/'+BRANCH_IDtrip+'/'+JOB_POSITIONtrip+'/'+ORDER_DATEtrip+'/'+EMP_IDtrip+'/'+AIM+'/'+AIM_KAZ);
        
        if(ID_PERSONtrain != '' && DATE_BEGINtrain != '' && DATE_ENDtrain != '' && NAME_TRAIN != '' && CNT_DAYtrain != '' && SUM_TRAIN != '' && ADRESS_TRAIN != '' )
        {
        $.post('edit_employee', {"ID_PERSONtrain": ID_PERSONtrain,
                                 "DATE_BEGINtrain": DATE_BEGINtrain,
                                 "DATE_ENDtrain": DATE_ENDtrain,
                                 "NAME_TRAIN": NAME_TRAIN,
                                 "NAME_TRAIN_KAZ": NAME_TRAIN_KAZ,
                                 "CNT_DAYtrain": CNT_DAYtrain,
                                 "SUM_TRAIN": SUM_TRAIN,
                                 "ADRESS_TRAIN": ADRESS_TRAIN,
                                 "ADRESS_TRAIN_KAZ": ADRESS_TRAIN_KAZ                                                                                                                                                                    
                                }, function(d){
                                   $('#place_for_trip').html(d);
                                })
        }else{
    ...
    function addHospFunc(){
        ...
        if(ID_PERSONhosp != '' && DATE_BEGINhosp != '' && EMP_IDhosp != '' && today_date != '' && BRANCH_IDholi != '' && JOB_SPholi != '' && JOB_POSITIONholi != '' && AUTHOR_ID != '')
        {
        $.post('edit_employee', {"ID_PERSONhosp": ID_PERSONhosp,
    ...
    function addTrivialInfoFunc(){
            ...
            $.post('edit_employee', {"empIdTrivial": empIdTrivial,
                                    "LASTNAME": LASTNAME,
                                    "FIRSTNAME": FIRSTNAME,
